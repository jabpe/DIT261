...
static const char *opencl_program[] =
                  {"#ifdef cl_clang_storage_class_specifiers\n#pragma OPENCL EXTENSION cl_clang_storage_class_specifiers : enable\n#endif\n#pragma OPENCL EXTENSION cl_khr_byte_addressable_store : enable\n__kernel void dummy_kernel(__global unsigned char *dummy, int n)\n{\n    const int thread_gid = get_global_id(0);\n    \n    if (thread_gid >= n)\n        return;\n}\n#pragma OPENCL EXTENSION cl_khr_int64_base_atomics : enable\n#pragma OPENCL EXTENSION cl_khr_int64_extended_atomics : enable\ntypedef char int8_t;\ntypedef short int16_t;\ntypedef int int32_t;\ntypedef long int64_t;\ntypedef uchar uint8_t;\ntypedef ushort uint16_t;\ntypedef uint uint32_t;\ntypedef ulong uint64_t;\n#ifdef cl_nv_pragma_unroll\nstatic inline void mem_fence_global()\n{\n    asm(\"membar.gl;\");\n}\n#else\nstatic inline void mem_fence_global()\n{\n    mem_fence(CLK_LOCAL_MEM_FENCE | CLK_GLOBAL_MEM_FENCE);\n}\n#endif\nstatic inline void mem_fence_local()\n{\n    mem_fence(CLK_LOCAL_MEM_FENCE);\n}\nstatic inline uint8_t add8(uint8_t x, uint8_t y)\n{\n    return x + y;\n}\nstatic inline uint16_t add16(uint16_t x, uint16_t y)\n{\n    return x + y;\n}\nstatic inline uint32_t add32(uint32_t x, uint32_t y)\n{\n    return x + y;\n}\nstatic inline uint64_t add64(uint64_t x, uint64_t y)\n{\n    return x + y;\n}\nstatic inline uint8_t sub8(uint8_t x, uint8_t y)\n{\n    return x - y;\n}\nstatic inline uint16_t sub16(uint16_t x, uint16_t y)\n{\n    return x - y;\n}\nstatic inline uint32_t sub32(uint32_t x, uint32_t y)\n{\n    return x - y;\n}\nstatic inline uint64_t sub64(uint64_t x, uint64_t y)\n{\n    return x - y;\n}\nstatic inline uint8_t mul8(uint8_t x, uint8_t y)\n{\n    return x * y;\n}\nstatic inline uint16_t mul16(uint16_t x, uint16_t y)\n{\n    return x * y;\n}\nstatic inline uint32_t mul32(uint32_t x, uint32_t y)\n{\n    return x * y;\n}\nstatic inline uint64_t mul64(uint64_t x, uint64_t y)\n{\n    return x * y;\n}\nstatic inline uint8_t udiv8(uint8_t x, uint8_t y)\n{\n    return x / y;\n}\nstatic inline uint16_t udiv16(uint16_t x, uint16_t y)\n{\n    return x / y;\n}\nstatic inline uint32_t udiv32(uint3",
                   ...
                   " int64_t x) {\n#ifdef FUTHARK_CUDA\n  return atomicAnd((int64_t*)p, x);\n#else\n  return atom_and(p, x);\n#endif\n}\n\ninline int64_t atomic_or_i64_global(volatile __global int64_t *p, int64_t x) {\n#ifdef FUTHARK_CUDA\n  return atomicOr((int64_t*)p, x);\n#else\n  return atom_or(p, x);\n#endif\n}\n\ninline int64_t atomic_or_i64_local(volatile __local int64_t *p, int64_t x) {\n#ifdef FUTHARK_CUDA\n  return atomicOr((int64_t*)p, x);\n#else\n  return atom_or(p, x);\n#endif\n}\n\ninline int64_t atomic_xor_i64_global(volatile __global int64_t *p, int64_t x) {\n#ifdef FUTHARK_CUDA\n  return atomicXor((int64_t*)p, x);\n#else\n  return atom_xor(p, x);\n#endif\n}\n\ninline int64_t atomic_xor_i64_local(volatile __local int64_t *p, int64_t x) {\n#ifdef FUTHARK_CUDA\n  return atomicXor((int64_t*)p, x);\n#else\n  return atom_xor(p, x);\n#endif\n}\n\n// End of atomics.h\n\n\n\n\n__kernel void mainziscan_stage1_4406(__global int *global_failure,\n                                     __local volatile\n                                     int64_t *scan_arr_mem_4428_backing_aligned_0,\n                                     __local volatile\n                                     int64_t *scan_arr_mem_4426_backing_aligned_1,\n                                     int64_t implz2081U_4386,\n                                     int32_t num_threads_4420, __global\n                                     unsigned char *xs_mem_4408, __global\n                                     unsigned char *ys_mem_4409, __global\n                                     unsigned char *mem_4412, __global\n                                     unsigned char *mem_4414)\n{\n    #define segscan_group_sizze_4401 (mainzisegscan_group_sizze_4400)\n    \n    const int block_dim0 = 0;\n    const int block_dim1 = 1;\n    const int block_dim2 = 2;\n    __local volatile char *restrict scan_arr_mem_4428_backing_1 =\n                          (__local volatile\n                           char *) scan_arr_mem_4428_backing_aligned_0;\n    __local volatile char *restrict scan_arr_mem_4426_backing_",
                   "0 =\n                          (__local volatile\n                           char *) scan_arr_mem_4426_backing_aligned_1;\n    \n    if (*global_failure >= 0)\n        return;\n    \n    int32_t global_tid_4421;\n    int32_t local_tid_4422;\n    int64_t group_sizze_4425;\n    int32_t wave_sizze_4424;\n    int32_t group_tid_4423;\n    \n    global_tid_4421 = get_global_id(0);\n    local_tid_4422 = get_local_id(0);\n    group_sizze_4425 = get_local_size(0);\n    wave_sizze_4424 = LOCKSTEP_WIDTH;\n    group_tid_4423 = get_group_id(0);\n    \n    int32_t phys_tid_4406;\n    \n    phys_tid_4406 = global_tid_4421;\n    \n    __local char *scan_arr_mem_4426;\n    __local char *scan_arr_mem_4428;\n    \n    scan_arr_mem_4426 = (__local char *) scan_arr_mem_4426_backing_0;\n    scan_arr_mem_4428 = (__local char *) scan_arr_mem_4428_backing_1;\n    \n    int32_t x_4391;\n    bool x_4392;\n    int32_t x_4393;\n    bool x_4394;\n    \n    x_4391 = 0;\n    x_4392 = 0;\n    for (int64_t j_4430 = 0; j_4430 < sdiv_up64(implz2081U_4386,\n                                                sext_i32_i64(num_threads_4420));\n         j_4430++) {\n        int64_t chunk_offset_4431 = segscan_group_sizze_4401 * j_4430 +\n                sext_i32_i64(group_tid_4423) * (segscan_group_sizze_4401 *\n                                                sdiv_up64(implz2081U_4386,\n                                                          sext_i32_i64(num_threads_4420)));\n        int64_t flat_idx_4432 = chunk_offset_4431 +\n                sext_i32_i64(local_tid_4422);\n        int64_t gtid_4405 = flat_idx_4432;\n        \n        // threads in bounds read input\n        {\n            if (slt64(gtid_4405, implz2081U_4386)) {\n                int32_t x_4397 = ((__global int32_t *) xs_mem_4408)[gtid_4405];\n                bool x_4398 = ((__global bool *) ys_mem_4409)[gtid_4405];\n                \n                // write to-scan values to parameters\n                {\n                    x_4393 = x_4397;\n                    x_4394 = x_4398;\n              ",
                   "  }\n                // write mapped values results to global memory\n                { }\n            }\n        }\n        // do one intra-group scan operation\n        {\n            // maybe restore some to-scan values to parameters, or read neutral\n            {\n                if (!slt64(gtid_4405, implz2081U_4386)) {\n                    x_4393 = 0;\n                    x_4394 = 0;\n                }\n            }\n            // combine with carry and write to local memory\n            {\n                int32_t defunc_res_4395;\n                \n                if (x_4394) {\n                    defunc_res_4395 = x_4393;\n                } else {\n                    int32_t defunc_1_op_res_4396 = add32(x_4391, x_4393);\n                    \n                    defunc_res_4395 = defunc_1_op_res_4396;\n                }\n                ((__local\n                  int32_t *) scan_arr_mem_4426)[sext_i32_i64(local_tid_4422)] =\n                    defunc_res_4395;\n                ((__local\n                  bool *) scan_arr_mem_4428)[sext_i32_i64(local_tid_4422)] =\n                    x_4394;\n            }\n            barrier(CLK_LOCAL_MEM_FENCE);\n            \n            int32_t x_4433;\n            bool x_4434;\n            int32_t x_4435;\n            bool x_4436;\n            int32_t x_4439;\n            bool x_4440;\n            int32_t x_4441;\n            bool x_4442;\n            bool ltid_in_bounds_4445;\n            \n            ltid_in_bounds_4445 = slt64(sext_i32_i64(local_tid_4422),\n                                        segscan_group_sizze_4401);\n            \n            int32_t skip_threads_4446;\n            \n            // read input for in-block scan\n            {\n                if (ltid_in_bounds_4445) {\n                    x_4435 = ((volatile __local\n                               int32_t *) scan_arr_mem_4426)[sext_i32_i64(local_tid_4422)];\n                    x_4436 = ((volatile __local\n                               bool *) scan_arr_mem_4428)[sext_i32_i64(local_tid_4",
                   "422)];\n                    if ((local_tid_4422 - squot32(local_tid_4422, 32) * 32) ==\n                        0) {\n                        x_4433 = x_4435;\n                        x_4434 = x_4436;\n                    }\n                }\n            }\n            // in-block scan (hopefully no barriers needed)\n            {\n                skip_threads_4446 = 1;\n                while (slt32(skip_threads_4446, 32)) {\n                    if (sle32(skip_threads_4446, local_tid_4422 -\n                              squot32(local_tid_4422, 32) * 32) &&\n                        ltid_in_bounds_4445) {\n                        // read operands\n                        {\n                            x_4433 = ((volatile __local\n                                       int32_t *) scan_arr_mem_4426)[sext_i32_i64(local_tid_4422) -\n                                                                     sext_i32_i64(skip_threads_4446)];\n                            x_4434 = ((volatile __local\n                                       bool *) scan_arr_mem_4428)[sext_i32_i64(local_tid_4422) -\n                                                                  sext_i32_i64(skip_threads_4446)];\n                        }\n                        // perform operation\n                        {\n                            int32_t defunc_res_4437;\n                            \n                            if (x_4436) {\n                                defunc_res_4437 = x_4435;\n                            } else {\n                                int32_t defunc_1_op_res_4438 = add32(x_4433,\n                                                                     x_4435);\n                                \n                                defunc_res_4437 = defunc_1_op_res_4438;\n                            }\n                            x_4433 = defunc_res_4437;\n                            x_4434 = x_4436;\n                        }\n                    }\n                    if (sle32(wave_sizze_4424, skip_threads_4446)) {\n",
                   "                        barrier(CLK_LOCAL_MEM_FENCE);\n                    }\n                    if (sle32(skip_threads_4446, local_tid_4422 -\n                              squot32(local_tid_4422, 32) * 32) &&\n                        ltid_in_bounds_4445) {\n                        // write result\n                        {\n                            ((volatile __local\n                              int32_t *) scan_arr_mem_4426)[sext_i32_i64(local_tid_4422)] =\n                                x_4433;\n                            x_4435 = x_4433;\n                            ((volatile __local\n                              bool *) scan_arr_mem_4428)[sext_i32_i64(local_tid_4422)] =\n                                x_4434;\n                            x_4436 = x_4434;\n                        }\n                    }\n                    if (sle32(wave_sizze_4424, skip_threads_4446)) {\n                        barrier(CLK_LOCAL_MEM_FENCE);\n                    }\n                    skip_threads_4446 *= 2;\n                }\n            }\n            barrier(CLK_LOCAL_MEM_FENCE);\n            // last thread of block 'i' writes its result to offset 'i'\n            {\n                if ((local_tid_4422 - squot32(local_tid_4422, 32) * 32) == 31 &&\n                    ltid_in_bounds_4445) {\n                    ((volatile __local\n                      int32_t *) scan_arr_mem_4426)[sext_i32_i64(squot32(local_tid_4422,\n                                                                         32))] =\n                        x_4433;\n                    ((volatile __local\n                      bool *) scan_arr_mem_4428)[sext_i32_i64(squot32(local_tid_4422,\n                                                                      32))] =\n                        x_4434;\n                }\n            }\n            barrier(CLK_LOCAL_MEM_FENCE);\n            // scan the first block, after which offset 'i' contains carry-in for block 'i+1'\n            {\n                int32_t skip_threads_4447;\n           ",
                   "     \n                // read input for in-block scan\n                {\n                    if (squot32(local_tid_4422, 32) == 0 &&\n                        ltid_in_bounds_4445) {\n                        x_4441 = ((volatile __local\n                                   int32_t *) scan_arr_mem_4426)[sext_i32_i64(local_tid_4422)];\n                        x_4442 = ((volatile __local\n                                   bool *) scan_arr_mem_4428)[sext_i32_i64(local_tid_4422)];\n                        if ((local_tid_4422 - squot32(local_tid_4422, 32) *\n                             32) == 0) {\n                            x_4439 = x_4441;\n                            x_4440 = x_4442;\n                        }\n                    }\n                }\n                // in-block scan (hopefully no barriers needed)\n                {\n                    skip_threads_4447 = 1;\n                    while (slt32(skip_threads_4447, 32)) {\n                        if (sle32(skip_threads_4447, local_tid_4422 -\n                                  squot32(local_tid_4422, 32) * 32) &&\n                            (squot32(local_tid_4422, 32) == 0 &&\n                             ltid_in_bounds_4445)) {\n                            // read operands\n                            {\n                                x_4439 = ((volatile __local\n                                           int32_t *) scan_arr_mem_4426)[sext_i32_i64(local_tid_4422) -\n                                                                         sext_i32_i64(skip_threads_4447)];\n                                x_4440 = ((volatile __local\n                                           bool *) scan_arr_mem_4428)[sext_i32_i64(local_tid_4422) -\n                                                                      sext_i32_i64(skip_threads_4447)];\n                            }\n                            // perform operation\n                            {\n                                int32_t defunc_res_4443;\n                                \n  ",
                   "                              if (x_4442) {\n                                    defunc_res_4443 = x_4441;\n                                } else {\n                                    int32_t defunc_1_op_res_4444 = add32(x_4439,\n                                                                         x_4441);\n                                    \n                                    defunc_res_4443 = defunc_1_op_res_4444;\n                                }\n                                x_4439 = defunc_res_4443;\n                                x_4440 = x_4442;\n                            }\n                        }\n                        if (sle32(wave_sizze_4424, skip_threads_4447)) {\n                            barrier(CLK_LOCAL_MEM_FENCE);\n                        }\n                        if (sle32(skip_threads_4447, local_tid_4422 -\n                                  squot32(local_tid_4422, 32) * 32) &&\n                            (squot32(local_tid_4422, 32) == 0 &&\n                             ltid_in_bounds_4445)) {\n                            // write result\n                            {\n                                ((volatile __local\n                                  int32_t *) scan_arr_mem_4426)[sext_i32_i64(local_tid_4422)] =\n                                    x_4439;\n                                x_4441 = x_4439;\n                                ((volatile __local\n                                  bool *) scan_arr_mem_4428)[sext_i32_i64(local_tid_4422)] =\n                                    x_4440;\n                                x_4442 = x_4440;\n                            }\n                        }\n                        if (sle32(wave_sizze_4424, skip_threads_4447)) {\n                            barrier(CLK_LOCAL_MEM_FENCE);\n                        }\n                        skip_threads_4447 *= 2;\n                    }\n                }\n            }\n            barrier(CLK_LOCAL_MEM_FENCE);\n            // carry-in for every block except the first",
                   "\n            {\n                if (!(squot32(local_tid_4422, 32) == 0 ||\n                      !ltid_in_bounds_4445)) {\n                    // read operands\n                    {\n                        x_4435 = x_4433;\n                        x_4436 = x_4434;\n                        x_4433 = ((__local\n                                   int32_t *) scan_arr_mem_4426)[sext_i32_i64(squot32(local_tid_4422,\n                                                                                      32)) -\n                                                                 (int64_t) 1];\n                        x_4434 = ((__local\n                                   bool *) scan_arr_mem_4428)[sext_i32_i64(squot32(local_tid_4422,\n                                                                                   32)) -\n                                                              (int64_t) 1];\n                    }\n                    // perform operation\n                    {\n                        int32_t defunc_res_4437;\n                        \n                        if (x_4436) {\n                            defunc_res_4437 = x_4435;\n                        } else {\n                            int32_t defunc_1_op_res_4438 = add32(x_4433,\n                                                                 x_4435);\n                            \n                            defunc_res_4437 = defunc_1_op_res_4438;\n                        }\n                        x_4433 = defunc_res_4437;\n                        x_4434 = x_4436;\n                    }\n                    // write final result\n                    {\n                        ((__local\n                          int32_t *) scan_arr_mem_4426)[sext_i32_i64(local_tid_4422)] =\n                            x_4433;\n                        ((__local\n                          bool *) scan_arr_mem_4428)[sext_i32_i64(local_tid_4422)] =\n                            x_4434;\n                    }\n                }\n            }\n            barr",
                   "ier(CLK_LOCAL_MEM_FENCE);\n            // restore correct values for first block\n            {\n                if (squot32(local_tid_4422, 32) == 0) {\n                    ((__local\n                      int32_t *) scan_arr_mem_4426)[sext_i32_i64(local_tid_4422)] =\n                        x_4435;\n                    ((__local\n                      bool *) scan_arr_mem_4428)[sext_i32_i64(local_tid_4422)] =\n                        x_4436;\n                }\n            }\n            barrier(CLK_LOCAL_MEM_FENCE);\n            // threads in bounds write partial scan result\n            {\n                if (slt64(gtid_4405, implz2081U_4386)) {\n                    ((__global int32_t *) mem_4412)[gtid_4405] = ((__local\n                                                                   int32_t *) scan_arr_mem_4426)[sext_i32_i64(local_tid_4422)];\n                    ((__global bool *) mem_4414)[gtid_4405] = ((__local\n                                                                bool *) scan_arr_mem_4428)[sext_i32_i64(local_tid_4422)];\n                }\n            }\n            barrier(CLK_LOCAL_MEM_FENCE);\n            // first thread reads last element as carry-in for next iteration\n            {\n                bool crosses_segment_4448 = 0;\n                bool should_load_carry_4449 = local_tid_4422 == 0 &&\n                     !crosses_segment_4448;\n                \n                if (should_load_carry_4449) {\n                    x_4391 = ((__local\n                               int32_t *) scan_arr_mem_4426)[segscan_group_sizze_4401 -\n                                                             (int64_t) 1];\n                    x_4392 = ((__local\n                               bool *) scan_arr_mem_4428)[segscan_group_sizze_4401 -\n                                                          (int64_t) 1];\n                }\n                if (!should_load_carry_4449) {\n                    x_4391 = 0;\n                    x_4392 = 0;\n                }\n            }\n            ",
                   "barrier(CLK_LOCAL_MEM_FENCE);\n        }\n    }\n    \n  error_1:\n    return;\n    #undef segscan_group_sizze_4401\n}\n__kernel void mainziscan_stage2_4406(__global int *global_failure,\n                                     __local volatile\n                                     int64_t *scan_arr_mem_4457_backing_aligned_0,\n                                     __local volatile\n                                     int64_t *scan_arr_mem_4455_backing_aligned_1,\n                                     int64_t implz2081U_4386,\n                                     int64_t stage1_num_groups_4419,\n                                     int32_t num_threads_4420, __global\n                                     unsigned char *mem_4412, __global\n                                     unsigned char *mem_4414)\n{\n    #define segscan_group_sizze_4401 (mainzisegscan_group_sizze_4400)\n    \n    const int block_dim0 = 0;\n    const int block_dim1 = 1;\n    const int block_dim2 = 2;\n    __local volatile char *restrict scan_arr_mem_4457_backing_1 =\n                          (__local volatile\n                           char *) scan_arr_mem_4457_backing_aligned_0;\n    __local volatile char *restrict scan_arr_mem_4455_backing_0 =\n                          (__local volatile\n                           char *) scan_arr_mem_4455_backing_aligned_1;\n    \n    if (*global_failure >= 0)\n        return;\n    \n    int32_t global_tid_4450;\n    int32_t local_tid_4451;\n    int64_t group_sizze_4454;\n    int32_t wave_sizze_4453;\n    int32_t group_tid_4452;\n    \n    global_tid_4450 = get_global_id(0);\n    local_tid_4451 = get_local_id(0);\n    group_sizze_4454 = get_local_size(0);\n    wave_sizze_4453 = LOCKSTEP_WIDTH;\n    group_tid_4452 = get_group_id(0);\n    \n    int32_t phys_tid_4406;\n    \n    phys_tid_4406 = global_tid_4450;\n    \n    __local char *scan_arr_mem_4455;\n    __local char *scan_arr_mem_4457;\n    \n    scan_arr_mem_4455 = (__local char *) scan_arr_mem_4455_backing_0;\n    scan_arr_mem_4457 = (__local char *) scan_arr_m",
                   "em_4457_backing_1;\n    \n    int64_t flat_idx_4459;\n    \n    flat_idx_4459 = (sext_i32_i64(local_tid_4451) + (int64_t) 1) *\n        (segscan_group_sizze_4401 * sdiv_up64(implz2081U_4386,\n                                              sext_i32_i64(num_threads_4420))) -\n        (int64_t) 1;\n    \n    int64_t gtid_4405;\n    \n    gtid_4405 = flat_idx_4459;\n    // threads in bound read carries; others get neutral element\n    {\n        if (slt64(gtid_4405, implz2081U_4386)) {\n            ((__local\n              int32_t *) scan_arr_mem_4455)[sext_i32_i64(local_tid_4451)] =\n                ((__global int32_t *) mem_4412)[gtid_4405];\n            ((__local bool *) scan_arr_mem_4457)[sext_i32_i64(local_tid_4451)] =\n                ((__global bool *) mem_4414)[gtid_4405];\n        } else {\n            ((__local\n              int32_t *) scan_arr_mem_4455)[sext_i32_i64(local_tid_4451)] = 0;\n            ((__local bool *) scan_arr_mem_4457)[sext_i32_i64(local_tid_4451)] =\n                0;\n        }\n    }\n    barrier(CLK_LOCAL_MEM_FENCE);\n    \n    int32_t x_4391;\n    bool x_4392;\n    int32_t x_4393;\n    bool x_4394;\n    int32_t x_4460;\n    bool x_4461;\n    int32_t x_4462;\n    bool x_4463;\n    bool ltid_in_bounds_4466;\n    \n    ltid_in_bounds_4466 = slt64(sext_i32_i64(local_tid_4451),\n                                stage1_num_groups_4419);\n    \n    int32_t skip_threads_4467;\n    \n    // read input for in-block scan\n    {\n        if (ltid_in_bounds_4466) {\n            x_4393 = ((volatile __local\n                       int32_t *) scan_arr_mem_4455)[sext_i32_i64(local_tid_4451)];\n            x_4394 = ((volatile __local\n                       bool *) scan_arr_mem_4457)[sext_i32_i64(local_tid_4451)];\n            if ((local_tid_4451 - squot32(local_tid_4451, 32) * 32) == 0) {\n                x_4391 = x_4393;\n                x_4392 = x_4394;\n            }\n        }\n    }\n    // in-block scan (hopefully no barriers needed)\n    {\n        skip_threads_4467 = 1;\n        while (slt32(skip_threads",
                   "_4467, 32)) {\n            if (sle32(skip_threads_4467, local_tid_4451 -\n                      squot32(local_tid_4451, 32) * 32) &&\n                ltid_in_bounds_4466) {\n                // read operands\n                {\n                    x_4391 = ((volatile __local\n                               int32_t *) scan_arr_mem_4455)[sext_i32_i64(local_tid_4451) -\n                                                             sext_i32_i64(skip_threads_4467)];\n                    x_4392 = ((volatile __local\n                               bool *) scan_arr_mem_4457)[sext_i32_i64(local_tid_4451) -\n                                                          sext_i32_i64(skip_threads_4467)];\n                }\n                // perform operation\n                {\n                    int32_t defunc_res_4395;\n                    \n                    if (x_4394) {\n                        defunc_res_4395 = x_4393;\n                    } else {\n                        int32_t defunc_1_op_res_4396 = add32(x_4391, x_4393);\n                        \n                        defunc_res_4395 = defunc_1_op_res_4396;\n                    }\n                    x_4391 = defunc_res_4395;\n                    x_4392 = x_4394;\n                }\n            }\n            if (sle32(wave_sizze_4453, skip_threads_4467)) {\n                barrier(CLK_LOCAL_MEM_FENCE);\n            }\n            if (sle32(skip_threads_4467, local_tid_4451 -\n                      squot32(local_tid_4451, 32) * 32) &&\n                ltid_in_bounds_4466) {\n                // write result\n                {\n                    ((volatile __local\n                      int32_t *) scan_arr_mem_4455)[sext_i32_i64(local_tid_4451)] =\n                        x_4391;\n                    x_4393 = x_4391;\n                    ((volatile __local\n                      bool *) scan_arr_mem_4457)[sext_i32_i64(local_tid_4451)] =\n                        x_4392;\n                    x_4394 = x_4392;\n                }\n            }\n            if (sle",
                   "32(wave_sizze_4453, skip_threads_4467)) {\n                barrier(CLK_LOCAL_MEM_FENCE);\n            }\n            skip_threads_4467 *= 2;\n        }\n    }\n    barrier(CLK_LOCAL_MEM_FENCE);\n    // last thread of block 'i' writes its result to offset 'i'\n    {\n        if ((local_tid_4451 - squot32(local_tid_4451, 32) * 32) == 31 &&\n            ltid_in_bounds_4466) {\n            ((volatile __local\n              int32_t *) scan_arr_mem_4455)[sext_i32_i64(squot32(local_tid_4451,\n                                                                 32))] = x_4391;\n            ((volatile __local\n              bool *) scan_arr_mem_4457)[sext_i32_i64(squot32(local_tid_4451,\n                                                              32))] = x_4392;\n        }\n    }\n    barrier(CLK_LOCAL_MEM_FENCE);\n    // scan the first block, after which offset 'i' contains carry-in for block 'i+1'\n    {\n        int32_t skip_threads_4468;\n        \n        // read input for in-block scan\n        {\n            if (squot32(local_tid_4451, 32) == 0 && ltid_in_bounds_4466) {\n                x_4462 = ((volatile __local\n                           int32_t *) scan_arr_mem_4455)[sext_i32_i64(local_tid_4451)];\n                x_4463 = ((volatile __local\n                           bool *) scan_arr_mem_4457)[sext_i32_i64(local_tid_4451)];\n                if ((local_tid_4451 - squot32(local_tid_4451, 32) * 32) == 0) {\n                    x_4460 = x_4462;\n                    x_4461 = x_4463;\n                }\n            }\n        }\n        // in-block scan (hopefully no barriers needed)\n        {\n            skip_threads_4468 = 1;\n            while (slt32(skip_threads_4468, 32)) {\n                if (sle32(skip_threads_4468, local_tid_4451 -\n                          squot32(local_tid_4451, 32) * 32) &&\n                    (squot32(local_tid_4451, 32) == 0 && ltid_in_bounds_4466)) {\n                    // read operands\n                    {\n                        x_4460 = ((volatile __local\n                 ",
                   "                  int32_t *) scan_arr_mem_4455)[sext_i32_i64(local_tid_4451) -\n                                                                 sext_i32_i64(skip_threads_4468)];\n                        x_4461 = ((volatile __local\n                                   bool *) scan_arr_mem_4457)[sext_i32_i64(local_tid_4451) -\n                                                              sext_i32_i64(skip_threads_4468)];\n                    }\n                    // perform operation\n                    {\n                        int32_t defunc_res_4464;\n                        \n                        if (x_4463) {\n                            defunc_res_4464 = x_4462;\n                        } else {\n                            int32_t defunc_1_op_res_4465 = add32(x_4460,\n                                                                 x_4462);\n                            \n                            defunc_res_4464 = defunc_1_op_res_4465;\n                        }\n                        x_4460 = defunc_res_4464;\n                        x_4461 = x_4463;\n                    }\n                }\n                if (sle32(wave_sizze_4453, skip_threads_4468)) {\n                    barrier(CLK_LOCAL_MEM_FENCE);\n                }\n                if (sle32(skip_threads_4468, local_tid_4451 -\n                          squot32(local_tid_4451, 32) * 32) &&\n                    (squot32(local_tid_4451, 32) == 0 && ltid_in_bounds_4466)) {\n                    // write result\n                    {\n                        ((volatile __local\n                          int32_t *) scan_arr_mem_4455)[sext_i32_i64(local_tid_4451)] =\n                            x_4460;\n                        x_4462 = x_4460;\n                        ((volatile __local\n                          bool *) scan_arr_mem_4457)[sext_i32_i64(local_tid_4451)] =\n                            x_4461;\n                        x_4463 = x_4461;\n                    }\n                }\n                if (sle32(wave_sizze_4453, ski",
                   "p_threads_4468)) {\n                    barrier(CLK_LOCAL_MEM_FENCE);\n                }\n                skip_threads_4468 *= 2;\n            }\n        }\n    }\n    barrier(CLK_LOCAL_MEM_FENCE);\n    // carry-in for every block except the first\n    {\n        if (!(squot32(local_tid_4451, 32) == 0 || !ltid_in_bounds_4466)) {\n            // read operands\n            {\n                x_4393 = x_4391;\n                x_4394 = x_4392;\n                x_4391 = ((__local\n                           int32_t *) scan_arr_mem_4455)[sext_i32_i64(squot32(local_tid_4451,\n                                                                              32)) -\n                                                         (int64_t) 1];\n                x_4392 = ((__local\n                           bool *) scan_arr_mem_4457)[sext_i32_i64(squot32(local_tid_4451,\n                                                                           32)) -\n                                                      (int64_t) 1];\n            }\n            // perform operation\n            {\n                int32_t defunc_res_4395;\n                \n                if (x_4394) {\n                    defunc_res_4395 = x_4393;\n                } else {\n                    int32_t defunc_1_op_res_4396 = add32(x_4391, x_4393);\n                    \n                    defunc_res_4395 = defunc_1_op_res_4396;\n                }\n                x_4391 = defunc_res_4395;\n                x_4392 = x_4394;\n            }\n            // write final result\n            {\n                ((__local\n                  int32_t *) scan_arr_mem_4455)[sext_i32_i64(local_tid_4451)] =\n                    x_4391;\n                ((__local\n                  bool *) scan_arr_mem_4457)[sext_i32_i64(local_tid_4451)] =\n                    x_4392;\n            }\n        }\n    }\n    barrier(CLK_LOCAL_MEM_FENCE);\n    // restore correct values for first block\n    {\n        if (squot32(local_tid_4451, 32) == 0) {\n            ((__local\n              int32_t *) sca",
                   "n_arr_mem_4455)[sext_i32_i64(local_tid_4451)] =\n                x_4393;\n            ((__local bool *) scan_arr_mem_4457)[sext_i32_i64(local_tid_4451)] =\n                x_4394;\n        }\n    }\n    barrier(CLK_LOCAL_MEM_FENCE);\n    // threads in bounds write scanned carries\n    {\n        if (slt64(gtid_4405, implz2081U_4386)) {\n            ((__global int32_t *) mem_4412)[gtid_4405] = ((__local\n                                                           int32_t *) scan_arr_mem_4455)[sext_i32_i64(local_tid_4451)];\n            ((__global bool *) mem_4414)[gtid_4405] = ((__local\n                                                        bool *) scan_arr_mem_4457)[sext_i32_i64(local_tid_4451)];\n        }\n    }\n    \n  error_0:\n    return;\n    #undef segscan_group_sizze_4401\n}\n__kernel void mainziscan_stage3_4406(__global int *global_failure,\n                                     int64_t implz2081U_4386,\n                                     int64_t num_groups_4403,\n                                     int32_t num_threads_4420,\n                                     int32_t required_groups_4469, __global\n                                     unsigned char *mem_4412, __global\n                                     unsigned char *mem_4414)\n{\n    #define segscan_group_sizze_4401 (mainzisegscan_group_sizze_4400)\n    \n    const int block_dim0 = 0;\n    const int block_dim1 = 1;\n    const int block_dim2 = 2;\n    \n    if (*global_failure >= 0)\n        return;\n    \n    int32_t global_tid_4470;\n    int32_t local_tid_4471;\n    int64_t group_sizze_4474;\n    int32_t wave_sizze_4473;\n    int32_t group_tid_4472;\n    \n    global_tid_4470 = get_global_id(0);\n    local_tid_4471 = get_local_id(0);\n    group_sizze_4474 = get_local_size(0);\n    wave_sizze_4473 = LOCKSTEP_WIDTH;\n    group_tid_4472 = get_group_id(0);\n    \n    int32_t phys_tid_4406;\n    \n    phys_tid_4406 = global_tid_4470;\n    \n    int32_t phys_group_id_4475;\n    \n    phys_group_id_4475 = get_group_id(0);\n    for (int32_t i_4476 = 0; i_4476",
                   " < sdiv_up32(required_groups_4469 -\n                                                phys_group_id_4475,\n                                                sext_i64_i32(num_groups_4403));\n         i_4476++) {\n        int32_t virt_group_id_4477 = phys_group_id_4475 + i_4476 *\n                sext_i64_i32(num_groups_4403);\n        int64_t flat_idx_4478 = sext_i32_i64(virt_group_id_4477) *\n                segscan_group_sizze_4401 + sext_i32_i64(local_tid_4471);\n        int64_t gtid_4405 = flat_idx_4478;\n        int64_t orig_group_4479 = squot64(flat_idx_4478,\n                                          segscan_group_sizze_4401 *\n                                          sdiv_up64(implz2081U_4386,\n                                                    sext_i32_i64(num_threads_4420)));\n        int64_t carry_in_flat_idx_4480 = orig_group_4479 *\n                (segscan_group_sizze_4401 * sdiv_up64(implz2081U_4386,\n                                                      sext_i32_i64(num_threads_4420))) -\n                (int64_t) 1;\n        \n        if (slt64(gtid_4405, implz2081U_4386)) {\n            if (!(orig_group_4479 == (int64_t) 0 || flat_idx_4478 ==\n                  (orig_group_4479 + (int64_t) 1) * (segscan_group_sizze_4401 *\n                                                     sdiv_up64(implz2081U_4386,\n                                                               sext_i32_i64(num_threads_4420))) -\n                  (int64_t) 1)) {\n                int32_t x_4391;\n                bool x_4392;\n                int32_t x_4393;\n                bool x_4394;\n                \n                x_4391 = ((__global\n                           int32_t *) mem_4412)[carry_in_flat_idx_4480];\n                x_4392 = ((__global bool *) mem_4414)[carry_in_flat_idx_4480];\n                x_4393 = ((__global int32_t *) mem_4412)[gtid_4405];\n                x_4394 = ((__global bool *) mem_4414)[gtid_4405];\n                \n                int32_t defunc_res_4395;\n                \n             ",
                   "   if (x_4394) {\n                    defunc_res_4395 = x_4393;\n                } else {\n                    int32_t defunc_1_op_res_4396 = add32(x_4391, x_4393);\n                    \n                    defunc_res_4395 = defunc_1_op_res_4396;\n                }\n                x_4391 = defunc_res_4395;\n                x_4392 = x_4394;\n                ((__global int32_t *) mem_4412)[gtid_4405] = x_4391;\n                ((__global bool *) mem_4414)[gtid_4405] = x_4392;\n            }\n        }\n        barrier(CLK_GLOBAL_MEM_FENCE | CLK_LOCAL_MEM_FENCE);\n    }\n    \n  error_0:\n    return;\n    #undef segscan_group_sizze_4401\n}\n",
                   NULL};
static const char *size_names[] = {"main.segscan_group_size_4400",
                                   "main.segscan_num_groups_4402"};
static const char *size_vars[] = {"mainzisegscan_group_sizze_4400",
                                  "mainzisegscan_num_groups_4402"};
static const char *size_classes[] = {"group_size", "num_groups"};
struct sizes {
    int64_t mainzisegscan_group_sizze_4400;
    int64_t mainzisegscan_num_groups_4402;
} ;
struct futhark_context_config {
...
struct futhark_context {
    ...
    int total_runs;
    long total_runtime;
    cl_kernel mainziscan_stage1_4406;
    cl_kernel mainziscan_stage2_4406;
    cl_kernel mainziscan_stage3_4406;
    ...
    int64_t mainziscan_stage1_4406_total_runtime;
    int mainziscan_stage1_4406_runs;
    int64_t mainziscan_stage2_4406_total_runtime;
    int mainziscan_stage2_4406_runs;
    int64_t mainziscan_stage3_4406_total_runtime;
    int mainziscan_stage3_4406_runs;
                               ...
                               struct futhark_context *ctx)
{
    ...
    ctx->mainziscan_stage1_4406_total_runtime = 0;
    ctx->mainziscan_stage1_4406_runs = 0;
    ctx->mainziscan_stage2_4406_total_runtime = 0;
    ctx->mainziscan_stage2_4406_runs = 0;
    ctx->mainziscan_stage3_4406_total_runtime = 0;
    ctx->mainziscan_stage3_4406_runs = 0;
}
                             ...
                             struct futhark_context *ctx, cl_program prog)
{
    ...
    OPENCL_SUCCEED_OR_RETURN(error);
    {
        ctx->mainziscan_stage1_4406 = clCreateKernel(prog,
                                                     "mainziscan_stage1_4406",
                                                     &error);
        OPENCL_SUCCEED_FATAL(error);
        OPENCL_SUCCEED_FATAL(clSetKernelArg(ctx->mainziscan_stage1_4406, 0,
                                            sizeof(cl_mem),
                                            &ctx->global_failure));
        if (ctx->debugging)
            fprintf(ctx->log, "Created kernel %s.\n", "main.scan_stage1_4406");
    }
    {
        ctx->mainziscan_stage2_4406 = clCreateKernel(prog,
                                                     "mainziscan_stage2_4406",
                                                     &error);
        OPENCL_SUCCEED_FATAL(error);
        OPENCL_SUCCEED_FATAL(clSetKernelArg(ctx->mainziscan_stage2_4406, 0,
                                            sizeof(cl_mem),
                                            &ctx->global_failure));
        if (ctx->debugging)
            fprintf(ctx->log, "Created kernel %s.\n", "main.scan_stage2_4406");
    }
    {
        ctx->mainziscan_stage3_4406 = clCreateKernel(prog,
                                                     "mainziscan_stage3_4406",
                                                     &error);
        OPENCL_SUCCEED_FATAL(error);
        OPENCL_SUCCEED_FATAL(clSetKernelArg(ctx->mainziscan_stage3_4406, 0,
                                            sizeof(cl_mem),
                                            &ctx->global_failure));
        if (ctx->debugging)
            fprintf(ctx->log, "Created kernel %s.\n", "main.scan_stage3_4406");
    }
    ctx->sizes.mainzisegscan_group_sizze_4400 = cfg->sizes[0];
    ctx->sizes.mainzisegscan_num_groups_4402 = cfg->sizes[1];
    init_constants(ctx);
...
void futhark_context_free(struct futhark_context *ctx)
{
    free_constants(ctx);
    free_lock(&ctx->lock);
    OPENCL_SUCCEED_FATAL(clReleaseKernel(ctx->mainziscan_stage1_4406));
    OPENCL_SUCCEED_FATAL(clReleaseKernel(ctx->mainziscan_stage2_4406));
    OPENCL_SUCCEED_FATAL(clReleaseKernel(ctx->mainziscan_stage3_4406));
...
char *futhark_context_report(struct futhark_context *ctx)
{
    ...
    if (ctx->profiling) {
        ...
        str_builder(&builder,
                    "main.scan_stage1_4406 ran %5d times; avg: %8ldus; total: %8ldus\n",
                    ctx->mainziscan_stage1_4406_runs,
                    (long) ctx->mainziscan_stage1_4406_total_runtime /
                    (ctx->mainziscan_stage1_4406_runs !=
                     0 ? ctx->mainziscan_stage1_4406_runs : 1),
                    (long) ctx->mainziscan_stage1_4406_total_runtime);
        ctx->total_runtime += ctx->mainziscan_stage1_4406_total_runtime;
        ctx->total_runs += ctx->mainziscan_stage1_4406_runs;
        str_builder(&builder,
                    "main.scan_stage2_4406 ran %5d times; avg: %8ldus; total: %8ldus\n",
                    ctx->mainziscan_stage2_4406_runs,
                    (long) ctx->mainziscan_stage2_4406_total_runtime /
                    (ctx->mainziscan_stage2_4406_runs !=
                     0 ? ctx->mainziscan_stage2_4406_runs : 1),
                    (long) ctx->mainziscan_stage2_4406_total_runtime);
        ctx->total_runtime += ctx->mainziscan_stage2_4406_total_runtime;
        ctx->total_runs += ctx->mainziscan_stage2_4406_runs;
        str_builder(&builder,
                    "main.scan_stage3_4406 ran %5d times; avg: %8ldus; total: %8ldus\n",
                    ctx->mainziscan_stage3_4406_runs,
                    (long) ctx->mainziscan_stage3_4406_total_runtime /
                    (ctx->mainziscan_stage3_4406_runs !=
                     0 ? ctx->mainziscan_stage3_4406_runs : 1),
                    (long) ctx->mainziscan_stage3_4406_total_runtime);
        ctx->total_runtime += ctx->mainziscan_stage3_4406_total_runtime;
        ctx->total_runs += ctx->mainziscan_stage3_4406_runs;
...
static int futrts_main(struct futhark_context *ctx,
                       struct memblock_device *out_mem_p_4481,
                       struct memblock_device xs_mem_4408,
                       struct memblock_device ys_mem_4409,
                       int64_t implz2081U_4386);
                       ...
                       int64_t implz2081U_4386)
{
    ...
    int err = 0;
    struct memblock_device out_mem_4416;
    
    out_mem_4416.references = NULL;
    
    int64_t segscan_group_sizze_4401;
    
    segscan_group_sizze_4401 = ctx->sizes.mainzisegscan_group_sizze_4400;
    
    int64_t num_groups_4403;
    int32_t max_num_groups_4417;
    
    max_num_groups_4417 = ctx->sizes.mainzisegscan_num_groups_4402;
    num_groups_4403 = sext_i64_i32(smax64((int64_t) 1,
                                          smin64(sdiv_up64(implz2081U_4386,
                                                           segscan_group_sizze_4401),
                                                 sext_i32_i64(max_num_groups_4417))));
    
    int64_t bytes_4411 = (int64_t) 4 * implz2081U_4386;
    struct memblock_device mem_4412;
    
    mem_4412.references = NULL;
    if (memblock_alloc_device(ctx, &mem_4412, bytes_4411, "mem_4412")) {
        err = 1;
        goto cleanup;
    }
    
    struct memblock_device mem_4414;
    
    mem_4414.references = NULL;
    if (memblock_alloc_device(ctx, &mem_4414, implz2081U_4386, "mem_4414")) {
        err = 1;
        goto cleanup;
    }
    if (slt64((int64_t) 0, implz2081U_4386)) {
        if (ctx->debugging)
            fprintf(ctx->log, "%s\n", "\n# SegScan");
        
        int64_t stage1_max_num_groups_4418;
        
        stage1_max_num_groups_4418 = ctx->opencl.max_group_size;
        
        int64_t stage1_num_groups_4419;
        
        stage1_num_groups_4419 = smin64(stage1_max_num_groups_4418,
                                        num_groups_4403);
        
        int32_t num_threads_4420;
        
        num_threads_4420 = sext_i64_i32(stage1_num_groups_4419 *
            segscan_group_sizze_4401);
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage1_4406, 1,
                                                smax64((int64_t) 1,
                                                       (int64_t) sizeof(bool) *
                                                       segscan_group_sizze_4401),
                                                NULL));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage1_4406, 2,
                                                smax64((int64_t) 1,
                                                       (int64_t) sizeof(int32_t) *
                                                       segscan_group_sizze_4401),
                                                NULL));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage1_4406, 3,
                                                sizeof(implz2081U_4386),
                                                &implz2081U_4386));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage1_4406, 4,
                                                sizeof(num_threads_4420),
                                                &num_threads_4420));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage1_4406, 5,
                                                sizeof(xs_mem_4408.mem),
                                                &xs_mem_4408.mem));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage1_4406, 6,
                                                sizeof(ys_mem_4409.mem),
                                                &ys_mem_4409.mem));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage1_4406, 7,
                                                sizeof(mem_4412.mem),
                                                &mem_4412.mem));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage1_4406, 8,
                                                sizeof(mem_4414.mem),
                                                &mem_4414.mem));
        if (1 * ((size_t) stage1_num_groups_4419 *
                 (size_t) segscan_group_sizze_4401) != 0) {
            const size_t global_work_sizze_4482[1] =
                         {(size_t) stage1_num_groups_4419 *
                         (size_t) segscan_group_sizze_4401};
            const size_t local_work_sizze_4486[1] = {segscan_group_sizze_4401};
            int64_t time_start_4483 = 0, time_end_4484 = 0;
            
            if (ctx->debugging) {
                fprintf(ctx->log, "Launching %s with global work size [",
                        "main.scan_stage1_4406");
                fprintf(ctx->log, "%zu", global_work_sizze_4482[0]);
                fprintf(ctx->log, "] and local work size [");
                fprintf(ctx->log, "%zu", local_work_sizze_4486[0]);
                fprintf(ctx->log,
                        "]; local memory parameters sum to %d bytes.\n",
                        (int) (0 + smax64((int64_t) 1, (int64_t) sizeof(bool) *
                                          segscan_group_sizze_4401) +
                               smax64((int64_t) 1, (int64_t) sizeof(int32_t) *
                                      segscan_group_sizze_4401)));
                time_start_4483 = get_wall_time();
            }
            OPENCL_SUCCEED_OR_RETURN(clEnqueueNDRangeKernel(ctx->opencl.queue,
                                                            ctx->mainziscan_stage1_4406,
                                                            1, NULL,
                                                            ...
                                                            !ctx->profiling ? NULL : opencl_get_event(&ctx->opencl,
                                                                                                      &ctx->mainziscan_stage1_4406_runs,
                                                                                                      &ctx->mainziscan_stage1_4406_total_runtime)));
            if (ctx->debugging) {
                ...
                fprintf(ctx->log, "kernel %s runtime: %ldus\n",
                        "main.scan_stage1_4406", time_diff_4485);
            }
        }
        if (ctx->debugging)
            fprintf(ctx->log, "%s: %llu%c", "elems_per_group",
                    (long long) (segscan_group_sizze_4401 *
                                 sdiv_up64(implz2081U_4386,
                                           sext_i32_i64(num_threads_4420))),
                    '\n');
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage2_4406, 1,
                                                smax64((int64_t) 1,
                                                       (int64_t) sizeof(bool) *
                                                       stage1_num_groups_4419),
                                                NULL));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage2_4406, 2,
                                                smax64((int64_t) 1,
                                                       (int64_t) sizeof(int32_t) *
                                                       stage1_num_groups_4419),
                                                NULL));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage2_4406, 3,
                                                sizeof(implz2081U_4386),
                                                &implz2081U_4386));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage2_4406, 4,
                                                sizeof(stage1_num_groups_4419),
                                                &stage1_num_groups_4419));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage2_4406, 5,
                                                sizeof(num_threads_4420),
                                                &num_threads_4420));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage2_4406, 6,
                                                sizeof(mem_4412.mem),
                                                &mem_4412.mem));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage2_4406, 7,
                                                sizeof(mem_4414.mem),
                                                &mem_4414.mem));
        if (1 * ((size_t) (int64_t) 1 * (size_t) stage1_num_groups_4419) != 0) {
            const size_t global_work_sizze_4487[1] = {(size_t) (int64_t) 1 *
                         (size_t) stage1_num_groups_4419};
            const size_t local_work_sizze_4491[1] = {stage1_num_groups_4419};
            int64_t time_start_4488 = 0, time_end_4489 = 0;
            
            if (ctx->debugging) {
                fprintf(ctx->log, "Launching %s with global work size [",
                        "main.scan_stage2_4406");
                fprintf(ctx->log, "%zu", global_work_sizze_4487[0]);
                fprintf(ctx->log, "] and local work size [");
                fprintf(ctx->log, "%zu", local_work_sizze_4491[0]);
                fprintf(ctx->log,
                        "]; local memory parameters sum to %d bytes.\n",
                        (int) (0 + smax64((int64_t) 1, (int64_t) sizeof(bool) *
                                          stage1_num_groups_4419) +
            ...
            OPENCL_SUCCEED_OR_RETURN(clEnqueueNDRangeKernel(ctx->opencl.queue,
                                                            ...
                                                            !ctx->profiling ? NULL : opencl_get_event(&ctx->opencl,
                                                                                                      &ctx->mainziscan_stage2_4406_runs,
                                                                                                      &ctx->mainziscan_stage2_4406_total_runtime)));
            if (ctx->debugging) {
                OPENCL_SUCCEED_FATAL(clFinish(ctx->opencl.queue));
                ...
                fprintf(ctx->log, "kernel %s runtime: %ldus\n",
                        "main.scan_stage2_4406", time_diff_4490);
            }
        }
        
        int32_t required_groups_4469;
        
        required_groups_4469 = sext_i64_i32(sdiv_up64(implz2081U_4386,
                                                      segscan_group_sizze_4401));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage3_4406, 1,
                                                sizeof(implz2081U_4386),
                                                &implz2081U_4386));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage3_4406, 2,
                                                sizeof(num_groups_4403),
                                                &num_groups_4403));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage3_4406, 3,
                                                sizeof(num_threads_4420),
                                                &num_threads_4420));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage3_4406, 4,
                                                sizeof(required_groups_4469),
                                                &required_groups_4469));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage3_4406, 5,
                                                sizeof(mem_4412.mem),
                                                &mem_4412.mem));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage3_4406, 6,
                                                sizeof(mem_4414.mem),
                                                &mem_4414.mem));
        if (1 * ((size_t) num_groups_4403 *
                 (size_t) segscan_group_sizze_4401) != 0) {
            const size_t global_work_sizze_4492[1] = {(size_t) num_groups_4403 *
                         (size_t) segscan_group_sizze_4401};
            const size_t local_work_sizze_4496[1] = {segscan_group_sizze_4401};
            int64_t time_start_4493 = 0, time_end_4494 = 0;
            
            if (ctx->debugging) {
                fprintf(ctx->log, "Launching %s with global work size [",
                        "main.scan_stage3_4406");
                fprintf(ctx->log, "%zu", global_work_sizze_4492[0]);
                fprintf(ctx->log, "] and local work size [");
                fprintf(ctx->log, "%zu", local_work_sizze_4496[0]);
                fprintf(ctx->log,
                        "]; local memory parameters sum to %d bytes.\n",
                        (int) 0);
            ...
            OPENCL_SUCCEED_OR_RETURN(clEnqueueNDRangeKernel(ctx->opencl.queue,
                                                            ...
                                                            !ctx->profiling ? NULL : opencl_get_event(&ctx->opencl,
                                                                                                      &ctx->mainziscan_stage3_4406_runs,
                                                                                                      &ctx->mainziscan_stage3_4406_total_runtime)));
            if (ctx->debugging) {
                OPENCL_SUCCEED_FATAL(clFinish(ctx->opencl.queue));
                ...
                fprintf(ctx->log, "kernel %s runtime: %ldus\n",
                        "main.scan_stage3_4406", time_diff_4495);
            }
        }
    }
    if (memblock_unref_device(ctx, &mem_4414, "mem_4414") != 0)
        return 1;
    if (memblock_set_device(ctx, &out_mem_4416, &mem_4412, "mem_4412") != 0)
        return 1;
    (*out_mem_p_4481).references = NULL;
    if (memblock_set_device(ctx, &*out_mem_p_4481, &out_mem_4416,
                            "out_mem_4416") != 0)
        return 1;
    if (memblock_unref_device(ctx, &mem_4414, "mem_4414") != 0)
        return 1;
    if (memblock_unref_device(ctx, &mem_4412, "mem_4412") != 0)
        return 1;
    if (memblock_unref_device(ctx, &out_mem_4416, "out_mem_4416") != 0)
        return 1;
                       ...
                       struct futhark_bool_1d *in1)
{
    ...
    xs_mem_4408.references = NULL;
    
    struct memblock_device ys_mem_4409;
    
    ys_mem_4409.references = NULL;
    ...
    lock_lock(&ctx->lock);
    xs_mem_4408 = in0->mem;
    implz2081U_4386 = in0->shape[0];
    ys_mem_4409 = in1->mem;
    implz2081U_4386 = in1->shape[0];
    if (!(implz2081U_4386 == in0->shape[0] && implz2081U_4386 ==
          in1->shape[0])) {
        ret = 1;
        if (!ctx->error)
            ctx->error =
        ...
        ret = futrts_main(ctx, &out_mem_4416, xs_mem_4408, ys_mem_4409,
                          implz2081U_4386);
        if (ret == 0) {
            assert((*out0 =
                    (struct futhark_i32_1d *) malloc(sizeof(struct futhark_i32_1d))) !=
                NULL);
            (*out0)->mem = out_mem_4416;
            (*out0)->shape[0] = implz2081U_4386;
        }
    }
    lock_unlock(&ctx->lock);
    return ret;
