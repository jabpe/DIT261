...
struct type *main_out_types[] = {&type_i32_1d, NULL};
...
struct type *types[] = {&type_bool_1d, &type_i32_1d, NULL};
...
static const char *opencl_program[] =
                  {"#ifdef cl_clang_storage_class_specifiers\n#pragma OPENCL EXTENSION cl_clang_storage_class_specifiers : enable\n#endif\n#pragma OPENCL EXTENSION cl_khr_byte_addressable_store : enable\n__kernel void dummy_kernel(__global unsigned char *dummy, int n)\n{\n    const int thread_gid = get_global_id(0);\n    \n    if (thread_gid >= n)\n        return;\n}\n#pragma OPENCL EXTENSION cl_khr_int64_base_atomics : enable\n#pragma OPENCL EXTENSION cl_khr_int64_extended_atomics : enable\ntypedef char int8_t;\ntypedef short int16_t;\ntypedef int int32_t;\ntypedef long int64_t;\ntypedef uchar uint8_t;\ntypedef ushort uint16_t;\ntypedef uint uint32_t;\ntypedef ulong uint64_t;\n#ifdef cl_nv_pragma_unroll\nstatic inline void mem_fence_global()\n{\n    asm(\"membar.gl;\");\n}\n#else\nstatic inline void mem_fence_global()\n{\n    mem_fence(CLK_LOCAL_MEM_FENCE | CLK_GLOBAL_MEM_FENCE);\n}\n#endif\nstatic inline void mem_fence_local()\n{\n    mem_fence(CLK_LOCAL_MEM_FENCE);\n}\nstatic inline uint8_t add8(uint8_t x, uint8_t y)\n{\n    return x + y;\n}\nstatic inline uint16_t add16(uint16_t x, uint16_t y)\n{\n    return x + y;\n}\nstatic inline uint32_t add32(uint32_t x, uint32_t y)\n{\n    return x + y;\n}\nstatic inline uint64_t add64(uint64_t x, uint64_t y)\n{\n    return x + y;\n}\nstatic inline uint8_t sub8(uint8_t x, uint8_t y)\n{\n    return x - y;\n}\nstatic inline uint16_t sub16(uint16_t x, uint16_t y)\n{\n    return x - y;\n}\nstatic inline uint32_t sub32(uint32_t x, uint32_t y)\n{\n    return x - y;\n}\nstatic inline uint64_t sub64(uint64_t x, uint64_t y)\n{\n    return x - y;\n}\nstatic inline uint8_t mul8(uint8_t x, uint8_t y)\n{\n    return x * y;\n}\nstatic inline uint16_t mul16(uint16_t x, uint16_t y)\n{\n    return x * y;\n}\nstatic inline uint32_t mul32(uint32_t x, uint32_t y)\n{\n    return x * y;\n}\nstatic inline uint64_t mul64(uint64_t x, uint64_t y)\n{\n    return x * y;\n}\nstatic inline uint8_t udiv8(uint8_t x, uint8_t y)\n{\n    return x / y;\n}\nstatic inline uint16_t udiv16(uint16_t x, uint16_t y)\n{\n    return x / y;\n}\nstatic inline uint32_t udiv32(uint3",
                   ...
                   " int64_t x) {\n#ifdef FUTHARK_CUDA\n  return atomicAnd((int64_t*)p, x);\n#else\n  return atom_and(p, x);\n#endif\n}\n\ninline int64_t atomic_or_i64_global(volatile __global int64_t *p, int64_t x) {\n#ifdef FUTHARK_CUDA\n  return atomicOr((int64_t*)p, x);\n#else\n  return atom_or(p, x);\n#endif\n}\n\ninline int64_t atomic_or_i64_local(volatile __local int64_t *p, int64_t x) {\n#ifdef FUTHARK_CUDA\n  return atomicOr((int64_t*)p, x);\n#else\n  return atom_or(p, x);\n#endif\n}\n\ninline int64_t atomic_xor_i64_global(volatile __global int64_t *p, int64_t x) {\n#ifdef FUTHARK_CUDA\n  return atomicXor((int64_t*)p, x);\n#else\n  return atom_xor(p, x);\n#endif\n}\n\ninline int64_t atomic_xor_i64_local(volatile __local int64_t *p, int64_t x) {\n#ifdef FUTHARK_CUDA\n  return atomicXor((int64_t*)p, x);\n#else\n  return atom_xor(p, x);\n#endif\n}\n\n// End of atomics.h\n\n\n\n\n__kernel void mainziscan_stage1_5250(__global int *global_failure,\n                                     __local volatile\n                                     int64_t *scan_arr_mem_5347_backing_aligned_0,\n                                     __local volatile\n                                     int64_t *scan_arr_mem_5349_backing_aligned_1,\n                                     int64_t implz2081U_5162,\n                                     int32_t num_threads_5341, __global\n                                     unsigned char *xs_mem_5314, __global\n                                     unsigned char *ys_mem_5315, __global\n                                     unsigned char *mem_5318, __global\n                                     unsigned char *mem_5320, __global\n                                     unsigned char *mem_5322, __global\n                                     unsigned char *mem_5324, __global\n                                     unsigned char *mem_5326)\n{\n    #define segscan_group_sizze_5245 (mainzisegscan_group_sizze_5244)\n    \n    const int block_dim0 = 0;\n    const int block_dim1 = 1;\n    const int block_dim2 = 2;\n    __local volatile char *rest",
                   "rict scan_arr_mem_5347_backing_1 =\n                          (__local volatile\n                           char *) scan_arr_mem_5347_backing_aligned_0;\n    __local volatile char *restrict scan_arr_mem_5349_backing_0 =\n                          (__local volatile\n                           char *) scan_arr_mem_5349_backing_aligned_1;\n    \n    if (*global_failure >= 0)\n        return;\n    \n    int32_t global_tid_5342;\n    int32_t local_tid_5343;\n    int64_t group_sizze_5346;\n    int32_t wave_sizze_5345;\n    int32_t group_tid_5344;\n    \n    global_tid_5342 = get_global_id(0);\n    local_tid_5343 = get_local_id(0);\n    group_sizze_5346 = get_local_size(0);\n    wave_sizze_5345 = LOCKSTEP_WIDTH;\n    group_tid_5344 = get_group_id(0);\n    \n    int32_t phys_tid_5250;\n    \n    phys_tid_5250 = global_tid_5342;\n    \n    __local char *scan_arr_mem_5347;\n    __local char *scan_arr_mem_5349;\n    \n    scan_arr_mem_5349 = (__local char *) scan_arr_mem_5349_backing_0;\n    scan_arr_mem_5347 = (__local char *) scan_arr_mem_5347_backing_1;\n    \n    int32_t x_5184;\n    bool x_5185;\n    int32_t x_5186;\n    bool x_5187;\n    \n    x_5184 = 0;\n    x_5185 = 0;\n    \n    int64_t x_5190;\n    int64_t y_5191;\n    \n    x_5190 = (int64_t) 0;\n    for (int64_t j_5352 = 0; j_5352 < sdiv_up64(implz2081U_5162,\n                                                sext_i32_i64(num_threads_5341));\n         j_5352++) {\n        int64_t chunk_offset_5353 = segscan_group_sizze_5245 * j_5352 +\n                sext_i32_i64(group_tid_5344) * (segscan_group_sizze_5245 *\n                                                sdiv_up64(implz2081U_5162,\n                                                          sext_i32_i64(num_threads_5341)));\n        int64_t flat_idx_5354 = chunk_offset_5353 +\n                sext_i32_i64(local_tid_5343);\n        int64_t gtid_5249 = flat_idx_5354;\n        \n        // threads in bounds read input\n        {\n            if (slt64(gtid_5249, implz2081U_5162)) {\n                int32_t x_5193 = ((__globa",
                   "l int32_t *) xs_mem_5314)[gtid_5249];\n                bool x_5194 = ((__global bool *) ys_mem_5315)[gtid_5249];\n                int64_t defunc_0_f_res_5196 = sub64(gtid_5249, (int64_t) 1);\n                bool defunc_0_p_res_t_res_5197 = sle64((int64_t) 0,\n                                                       defunc_0_f_res_5196);\n                bool x_5198 = x_5194 && defunc_0_p_res_t_res_5197;\n                bool cond_neg_5199 = !x_5198;\n                int64_t defunc_1_lifted_lambda_res_5200 =\n                        btoi_bool_i64(cond_neg_5199);\n                bool is_i_5201 = defunc_1_lifted_lambda_res_5200 == (int64_t) 0;\n                bool cond_neg_5202 = !is_i_5201;\n                int64_t part_res_5203 = btoi_bool_i64(cond_neg_5202);\n                int64_t part_res_5204 = btoi_bool_i64(is_i_5201);\n                \n                // write to-scan values to parameters\n                {\n                    x_5186 = x_5193;\n                    x_5187 = x_5194;\n                    y_5191 = part_res_5204;\n                }\n                // write mapped values results to global memory\n                {\n                    ((__global int64_t *) mem_5324)[gtid_5249] = part_res_5203;\n                    ((__global int64_t *) mem_5326)[gtid_5249] =\n                        defunc_0_f_res_5196;\n                }\n            }\n        }\n        // do one intra-group scan operation\n        {\n            // maybe restore some to-scan values to parameters, or read neutral\n            {\n                if (!slt64(gtid_5249, implz2081U_5162)) {\n                    x_5186 = 0;\n                    x_5187 = 0;\n                }\n            }\n            // combine with carry and write to local memory\n            {\n                int32_t defunc_res_5188;\n                \n                if (x_5187) {\n                    defunc_res_5188 = x_5186;\n                } else {\n                    int32_t defunc_1_op_res_5189 = add32(x_5184, x_5186);\n                    \n     ",
                   "               defunc_res_5188 = defunc_1_op_res_5189;\n                }\n                ((__local\n                  int32_t *) scan_arr_mem_5347)[sext_i32_i64(local_tid_5343)] =\n                    defunc_res_5188;\n                ((__local\n                  bool *) scan_arr_mem_5349)[sext_i32_i64(local_tid_5343)] =\n                    x_5187;\n            }\n            barrier(CLK_LOCAL_MEM_FENCE);\n            \n            int32_t x_5355;\n            bool x_5356;\n            int32_t x_5357;\n            bool x_5358;\n            int32_t x_5361;\n            bool x_5362;\n            int32_t x_5363;\n            bool x_5364;\n            bool ltid_in_bounds_5367;\n            \n            ltid_in_bounds_5367 = slt64(sext_i32_i64(local_tid_5343),\n                                        segscan_group_sizze_5245);\n            \n            int32_t skip_threads_5368;\n            \n            // read input for in-block scan\n            {\n                if (ltid_in_bounds_5367) {\n                    x_5357 = ((volatile __local\n                               int32_t *) scan_arr_mem_5347)[sext_i32_i64(local_tid_5343)];\n                    x_5358 = ((volatile __local\n                               bool *) scan_arr_mem_5349)[sext_i32_i64(local_tid_5343)];\n                    if ((local_tid_5343 - squot32(local_tid_5343, 32) * 32) ==\n                        0) {\n                        x_5355 = x_5357;\n                        x_5356 = x_5358;\n                    }\n                }\n            }\n            // in-block scan (hopefully no barriers needed)\n            {\n                skip_threads_5368 = 1;\n                while (slt32(skip_threads_5368, 32)) {\n                    if (sle32(skip_threads_5368, local_tid_5343 -\n                              squot32(local_tid_5343, 32) * 32) &&\n                        ltid_in_bounds_5367) {\n                        // read operands\n                        {\n                            x_5355 = ((volatile __local\n                          ",
                   "             int32_t *) scan_arr_mem_5347)[sext_i32_i64(local_tid_5343) -\n                                                                     sext_i32_i64(skip_threads_5368)];\n                            x_5356 = ((volatile __local\n                                       bool *) scan_arr_mem_5349)[sext_i32_i64(local_tid_5343) -\n                                                                  sext_i32_i64(skip_threads_5368)];\n                        }\n                        // perform operation\n                        {\n                            int32_t defunc_res_5359;\n                            \n                            if (x_5358) {\n                                defunc_res_5359 = x_5357;\n                            } else {\n                                int32_t defunc_1_op_res_5360 = add32(x_5355,\n                                                                     x_5357);\n                                \n                                defunc_res_5359 = defunc_1_op_res_5360;\n                            }\n                            x_5355 = defunc_res_5359;\n                            x_5356 = x_5358;\n                        }\n                    }\n                    if (sle32(wave_sizze_5345, skip_threads_5368)) {\n                        barrier(CLK_LOCAL_MEM_FENCE);\n                    }\n                    if (sle32(skip_threads_5368, local_tid_5343 -\n                              squot32(local_tid_5343, 32) * 32) &&\n                        ltid_in_bounds_5367) {\n                        // write result\n                        {\n                            ((volatile __local\n                              int32_t *) scan_arr_mem_5347)[sext_i32_i64(local_tid_5343)] =\n                                x_5355;\n                            x_5357 = x_5355;\n                            ((volatile __local\n                              bool *) scan_arr_mem_5349)[sext_i32_i64(local_tid_5343)] =\n                                x_5356;\n                          ",
                   "  x_5358 = x_5356;\n                        }\n                    }\n                    if (sle32(wave_sizze_5345, skip_threads_5368)) {\n                        barrier(CLK_LOCAL_MEM_FENCE);\n                    }\n                    skip_threads_5368 *= 2;\n                }\n            }\n            barrier(CLK_LOCAL_MEM_FENCE);\n            // last thread of block 'i' writes its result to offset 'i'\n            {\n                if ((local_tid_5343 - squot32(local_tid_5343, 32) * 32) == 31 &&\n                    ltid_in_bounds_5367) {\n                    ((volatile __local\n                      int32_t *) scan_arr_mem_5347)[sext_i32_i64(squot32(local_tid_5343,\n                                                                         32))] =\n                        x_5355;\n                    ((volatile __local\n                      bool *) scan_arr_mem_5349)[sext_i32_i64(squot32(local_tid_5343,\n                                                                      32))] =\n                        x_5356;\n                }\n            }\n            barrier(CLK_LOCAL_MEM_FENCE);\n            // scan the first block, after which offset 'i' contains carry-in for block 'i+1'\n            {\n                int32_t skip_threads_5369;\n                \n                // read input for in-block scan\n                {\n                    if (squot32(local_tid_5343, 32) == 0 &&\n                        ltid_in_bounds_5367) {\n                        x_5363 = ((volatile __local\n                                   int32_t *) scan_arr_mem_5347)[sext_i32_i64(local_tid_5343)];\n                        x_5364 = ((volatile __local\n                                   bool *) scan_arr_mem_5349)[sext_i32_i64(local_tid_5343)];\n                        if ((local_tid_5343 - squot32(local_tid_5343, 32) *\n                             32) == 0) {\n                            x_5361 = x_5363;\n                            x_5362 = x_5364;\n                        }\n                    }\n                }\n   ",
                   "             // in-block scan (hopefully no barriers needed)\n                {\n                    skip_threads_5369 = 1;\n                    while (slt32(skip_threads_5369, 32)) {\n                        if (sle32(skip_threads_5369, local_tid_5343 -\n                                  squot32(local_tid_5343, 32) * 32) &&\n                            (squot32(local_tid_5343, 32) == 0 &&\n                             ltid_in_bounds_5367)) {\n                            // read operands\n                            {\n                                x_5361 = ((volatile __local\n                                           int32_t *) scan_arr_mem_5347)[sext_i32_i64(local_tid_5343) -\n                                                                         sext_i32_i64(skip_threads_5369)];\n                                x_5362 = ((volatile __local\n                                           bool *) scan_arr_mem_5349)[sext_i32_i64(local_tid_5343) -\n                                                                      sext_i32_i64(skip_threads_5369)];\n                            }\n                            // perform operation\n                            {\n                                int32_t defunc_res_5365;\n                                \n                                if (x_5364) {\n                                    defunc_res_5365 = x_5363;\n                                } else {\n                                    int32_t defunc_1_op_res_5366 = add32(x_5361,\n                                                                         x_5363);\n                                    \n                                    defunc_res_5365 = defunc_1_op_res_5366;\n                                }\n                                x_5361 = defunc_res_5365;\n                                x_5362 = x_5364;\n                            }\n                        }\n                        if (sle32(wave_sizze_5345, skip_threads_5369)) {\n                            barrier(CLK_LOCAL_MEM_FENCE",
                   ");\n                        }\n                        if (sle32(skip_threads_5369, local_tid_5343 -\n                                  squot32(local_tid_5343, 32) * 32) &&\n                            (squot32(local_tid_5343, 32) == 0 &&\n                             ltid_in_bounds_5367)) {\n                            // write result\n                            {\n                                ((volatile __local\n                                  int32_t *) scan_arr_mem_5347)[sext_i32_i64(local_tid_5343)] =\n                                    x_5361;\n                                x_5363 = x_5361;\n                                ((volatile __local\n                                  bool *) scan_arr_mem_5349)[sext_i32_i64(local_tid_5343)] =\n                                    x_5362;\n                                x_5364 = x_5362;\n                            }\n                        }\n                        if (sle32(wave_sizze_5345, skip_threads_5369)) {\n                            barrier(CLK_LOCAL_MEM_FENCE);\n                        }\n                        skip_threads_5369 *= 2;\n                    }\n                }\n            }\n            barrier(CLK_LOCAL_MEM_FENCE);\n            // carry-in for every block except the first\n            {\n                if (!(squot32(local_tid_5343, 32) == 0 ||\n                      !ltid_in_bounds_5367)) {\n                    // read operands\n                    {\n                        x_5357 = x_5355;\n                        x_5358 = x_5356;\n                        x_5355 = ((__local\n                                   int32_t *) scan_arr_mem_5347)[sext_i32_i64(squot32(local_tid_5343,\n                                                                                      32)) -\n                                                                 (int64_t) 1];\n                        x_5356 = ((__local\n                                   bool *) scan_arr_mem_5349)[sext_i32_i64(squot32(local_tid_5343,\n                            ",
                   "                                                       32)) -\n                                                              (int64_t) 1];\n                    }\n                    // perform operation\n                    {\n                        int32_t defunc_res_5359;\n                        \n                        if (x_5358) {\n                            defunc_res_5359 = x_5357;\n                        } else {\n                            int32_t defunc_1_op_res_5360 = add32(x_5355,\n                                                                 x_5357);\n                            \n                            defunc_res_5359 = defunc_1_op_res_5360;\n                        }\n                        x_5355 = defunc_res_5359;\n                        x_5356 = x_5358;\n                    }\n                    // write final result\n                    {\n                        ((__local\n                          int32_t *) scan_arr_mem_5347)[sext_i32_i64(local_tid_5343)] =\n                            x_5355;\n                        ((__local\n                          bool *) scan_arr_mem_5349)[sext_i32_i64(local_tid_5343)] =\n                            x_5356;\n                    }\n                }\n            }\n            barrier(CLK_LOCAL_MEM_FENCE);\n            // restore correct values for first block\n            {\n                if (squot32(local_tid_5343, 32) == 0) {\n                    ((__local\n                      int32_t *) scan_arr_mem_5347)[sext_i32_i64(local_tid_5343)] =\n                        x_5357;\n                    ((__local\n                      bool *) scan_arr_mem_5349)[sext_i32_i64(local_tid_5343)] =\n                        x_5358;\n                }\n            }\n            barrier(CLK_LOCAL_MEM_FENCE);\n            // threads in bounds write partial scan result\n            {\n                if (slt64(gtid_5249, implz2081U_5162)) {\n                    ((__global int32_t *) mem_5318)[gtid_5249] = ((__local\n                              ",
                   "                                     int32_t *) scan_arr_mem_5347)[sext_i32_i64(local_tid_5343)];\n                    ((__global bool *) mem_5320)[gtid_5249] = ((__local\n                                                                bool *) scan_arr_mem_5349)[sext_i32_i64(local_tid_5343)];\n                }\n            }\n            barrier(CLK_LOCAL_MEM_FENCE);\n            // first thread reads last element as carry-in for next iteration\n            {\n                bool crosses_segment_5370 = 0;\n                bool should_load_carry_5371 = local_tid_5343 == 0 &&\n                     !crosses_segment_5370;\n                \n                if (should_load_carry_5371) {\n                    x_5184 = ((__local\n                               int32_t *) scan_arr_mem_5347)[segscan_group_sizze_5245 -\n                                                             (int64_t) 1];\n                    x_5185 = ((__local\n                               bool *) scan_arr_mem_5349)[segscan_group_sizze_5245 -\n                                                          (int64_t) 1];\n                }\n                if (!should_load_carry_5371) {\n                    x_5184 = 0;\n                    x_5185 = 0;\n                }\n            }\n            barrier(CLK_LOCAL_MEM_FENCE);\n        }\n        // do one intra-group scan operation\n        {\n            // maybe restore some to-scan values to parameters, or read neutral\n            {\n                if (!slt64(gtid_5249, implz2081U_5162)) {\n                    y_5191 = (int64_t) 0;\n                }\n            }\n            // combine with carry and write to local memory\n            {\n                int64_t zz_5192 = x_5190 + y_5191;\n                \n                ((__local\n                  int64_t *) scan_arr_mem_5347)[sext_i32_i64(local_tid_5343)] =\n                    zz_5192;\n            }\n            barrier(CLK_LOCAL_MEM_FENCE);\n            \n            int64_t x_5372;\n            int64_t y_5373;\n            int64_t x_537",
                   "5;\n            int64_t y_5376;\n            bool ltid_in_bounds_5378;\n            \n            ltid_in_bounds_5378 = slt64(sext_i32_i64(local_tid_5343),\n                                        segscan_group_sizze_5245);\n            \n            int32_t skip_threads_5379;\n            \n            // read input for in-block scan\n            {\n                if (ltid_in_bounds_5378) {\n                    y_5373 = ((volatile __local\n                               int64_t *) scan_arr_mem_5347)[sext_i32_i64(local_tid_5343)];\n                    if ((local_tid_5343 - squot32(local_tid_5343, 32) * 32) ==\n                        0) {\n                        x_5372 = y_5373;\n                    }\n                }\n            }\n            // in-block scan (hopefully no barriers needed)\n            {\n                skip_threads_5379 = 1;\n                while (slt32(skip_threads_5379, 32)) {\n                    if (sle32(skip_threads_5379, local_tid_5343 -\n                              squot32(local_tid_5343, 32) * 32) &&\n                        ltid_in_bounds_5378) {\n                        // read operands\n                        {\n                            x_5372 = ((volatile __local\n                                       int64_t *) scan_arr_mem_5347)[sext_i32_i64(local_tid_5343) -\n                                                                     sext_i32_i64(skip_threads_5379)];\n                        }\n                        // perform operation\n                        {\n                            int64_t zz_5374 = x_5372 + y_5373;\n                            \n                            x_5372 = zz_5374;\n                        }\n                    }\n                    if (sle32(wave_sizze_5345, skip_threads_5379)) {\n                        barrier(CLK_LOCAL_MEM_FENCE);\n                    }\n                    if (sle32(skip_threads_5379, local_tid_5343 -\n                              squot32(local_tid_5343, 32) * 32) &&\n                        ltid_in_bound",
                   "s_5378) {\n                        // write result\n                        {\n                            ((volatile __local\n                              int64_t *) scan_arr_mem_5347)[sext_i32_i64(local_tid_5343)] =\n                                x_5372;\n                            y_5373 = x_5372;\n                        }\n                    }\n                    if (sle32(wave_sizze_5345, skip_threads_5379)) {\n                        barrier(CLK_LOCAL_MEM_FENCE);\n                    }\n                    skip_threads_5379 *= 2;\n                }\n            }\n            barrier(CLK_LOCAL_MEM_FENCE);\n            // last thread of block 'i' writes its result to offset 'i'\n            {\n                if ((local_tid_5343 - squot32(local_tid_5343, 32) * 32) == 31 &&\n                    ltid_in_bounds_5378) {\n                    ((volatile __local\n                      int64_t *) scan_arr_mem_5347)[sext_i32_i64(squot32(local_tid_5343,\n                                                                         32))] =\n                        x_5372;\n                }\n            }\n            barrier(CLK_LOCAL_MEM_FENCE);\n            // scan the first block, after which offset 'i' contains carry-in for block 'i+1'\n            {\n                int32_t skip_threads_5380;\n                \n                // read input for in-block scan\n                {\n                    if (squot32(local_tid_5343, 32) == 0 &&\n                        ltid_in_bounds_5378) {\n                        y_5376 = ((volatile __local\n                                   int64_t *) scan_arr_mem_5347)[sext_i32_i64(local_tid_5343)];\n                        if ((local_tid_5343 - squot32(local_tid_5343, 32) *\n                             32) == 0) {\n                            x_5375 = y_5376;\n                        }\n                    }\n                }\n                // in-block scan (hopefully no barriers needed)\n                {\n                    skip_threads_5380 = 1;\n                    wh",
                   "ile (slt32(skip_threads_5380, 32)) {\n                        if (sle32(skip_threads_5380, local_tid_5343 -\n                                  squot32(local_tid_5343, 32) * 32) &&\n                            (squot32(local_tid_5343, 32) == 0 &&\n                             ltid_in_bounds_5378)) {\n                            // read operands\n                            {\n                                x_5375 = ((volatile __local\n                                           int64_t *) scan_arr_mem_5347)[sext_i32_i64(local_tid_5343) -\n                                                                         sext_i32_i64(skip_threads_5380)];\n                            }\n                            // perform operation\n                            {\n                                int64_t zz_5377 = x_5375 + y_5376;\n                                \n                                x_5375 = zz_5377;\n                            }\n                        }\n                        if (sle32(wave_sizze_5345, skip_threads_5380)) {\n                            barrier(CLK_LOCAL_MEM_FENCE);\n                        }\n                        if (sle32(skip_threads_5380, local_tid_5343 -\n                                  squot32(local_tid_5343, 32) * 32) &&\n                            (squot32(local_tid_5343, 32) == 0 &&\n                             ltid_in_bounds_5378)) {\n                            // write result\n                            {\n                                ((volatile __local\n                                  int64_t *) scan_arr_mem_5347)[sext_i32_i64(local_tid_5343)] =\n                                    x_5375;\n                                y_5376 = x_5375;\n                            }\n                        }\n                        if (sle32(wave_sizze_5345, skip_threads_5380)) {\n                            barrier(CLK_LOCAL_MEM_FENCE);\n                        }\n                        skip_threads_5380 *= 2;\n                    }\n                }\n            ",
                   "}\n            barrier(CLK_LOCAL_MEM_FENCE);\n            // carry-in for every block except the first\n            {\n                if (!(squot32(local_tid_5343, 32) == 0 ||\n                      !ltid_in_bounds_5378)) {\n                    // read operands\n                    {\n                        y_5373 = x_5372;\n                        x_5372 = ((__local\n                                   int64_t *) scan_arr_mem_5347)[sext_i32_i64(squot32(local_tid_5343,\n                                                                                      32)) -\n                                                                 (int64_t) 1];\n                    }\n                    // perform operation\n                    {\n                        int64_t zz_5374 = x_5372 + y_5373;\n                        \n                        x_5372 = zz_5374;\n                    }\n                    // write final result\n                    {\n                        ((__local\n                          int64_t *) scan_arr_mem_5347)[sext_i32_i64(local_tid_5343)] =\n                            x_5372;\n                    }\n                }\n            }\n            barrier(CLK_LOCAL_MEM_FENCE);\n            // restore correct values for first block\n            {\n                if (squot32(local_tid_5343, 32) == 0) {\n                    ((__local\n                      int64_t *) scan_arr_mem_5347)[sext_i32_i64(local_tid_5343)] =\n                        y_5373;\n                }\n            }\n            barrier(CLK_LOCAL_MEM_FENCE);\n            // threads in bounds write partial scan result\n            {\n                if (slt64(gtid_5249, implz2081U_5162)) {\n                    ((__global int64_t *) mem_5322)[gtid_5249] = ((__local\n                                                                   int64_t *) scan_arr_mem_5347)[sext_i32_i64(local_tid_5343)];\n                }\n            }\n            barrier(CLK_LOCAL_MEM_FENCE);\n            // first thread reads last element as carry-in fo",
                   "r next iteration\n            {\n                bool crosses_segment_5381 = 0;\n                bool should_load_carry_5382 = local_tid_5343 == 0 &&\n                     !crosses_segment_5381;\n                \n                if (should_load_carry_5382) {\n                    x_5190 = ((__local\n                               int64_t *) scan_arr_mem_5347)[segscan_group_sizze_5245 -\n                                                             (int64_t) 1];\n                }\n                if (!should_load_carry_5382) {\n                    x_5190 = (int64_t) 0;\n                }\n            }\n            barrier(CLK_LOCAL_MEM_FENCE);\n        }\n    }\n    \n  error_2:\n    return;\n    #undef segscan_group_sizze_5245\n}\n__kernel void mainziscan_stage2_5250(__global int *global_failure,\n                                     __local volatile\n                                     int64_t *scan_arr_mem_5388_backing_aligned_0,\n                                     __local volatile\n                                     int64_t *scan_arr_mem_5390_backing_aligned_1,\n                                     int64_t implz2081U_5162,\n                                     int64_t stage1_num_groups_5340,\n                                     int32_t num_threads_5341, __global\n                                     unsigned char *mem_5318, __global\n                                     unsigned char *mem_5320, __global\n                                     unsigned char *mem_5322)\n{\n    #define segscan_group_sizze_5245 (mainzisegscan_group_sizze_5244)\n    \n    const int block_dim0 = 0;\n    const int block_dim1 = 1;\n    const int block_dim2 = 2;\n    __local volatile char *restrict scan_arr_mem_5388_backing_1 =\n                          (__local volatile\n                           char *) scan_arr_mem_5388_backing_aligned_0;\n    __local volatile char *restrict scan_arr_mem_5390_backing_0 =\n                          (__local volatile\n                           char *) scan_arr_mem_5390_backing_aligned_1;\n  ",
                   "  \n    if (*global_failure >= 0)\n        return;\n    \n    int32_t global_tid_5383;\n    int32_t local_tid_5384;\n    int64_t group_sizze_5387;\n    int32_t wave_sizze_5386;\n    int32_t group_tid_5385;\n    \n    global_tid_5383 = get_global_id(0);\n    local_tid_5384 = get_local_id(0);\n    group_sizze_5387 = get_local_size(0);\n    wave_sizze_5386 = LOCKSTEP_WIDTH;\n    group_tid_5385 = get_group_id(0);\n    \n    int32_t phys_tid_5250;\n    \n    phys_tid_5250 = global_tid_5383;\n    \n    __local char *scan_arr_mem_5388;\n    __local char *scan_arr_mem_5390;\n    \n    scan_arr_mem_5390 = (__local char *) scan_arr_mem_5390_backing_0;\n    scan_arr_mem_5388 = (__local char *) scan_arr_mem_5388_backing_1;\n    \n    int64_t flat_idx_5393;\n    \n    flat_idx_5393 = (sext_i32_i64(local_tid_5384) + (int64_t) 1) *\n        (segscan_group_sizze_5245 * sdiv_up64(implz2081U_5162,\n                                              sext_i32_i64(num_threads_5341))) -\n        (int64_t) 1;\n    \n    int64_t gtid_5249;\n    \n    gtid_5249 = flat_idx_5393;\n    // threads in bound read carries; others get neutral element\n    {\n        if (slt64(gtid_5249, implz2081U_5162)) {\n            ((__local\n              int32_t *) scan_arr_mem_5388)[sext_i32_i64(local_tid_5384)] =\n                ((__global int32_t *) mem_5318)[gtid_5249];\n            ((__local bool *) scan_arr_mem_5390)[sext_i32_i64(local_tid_5384)] =\n                ((__global bool *) mem_5320)[gtid_5249];\n        } else {\n            ((__local\n              int32_t *) scan_arr_mem_5388)[sext_i32_i64(local_tid_5384)] = 0;\n            ((__local bool *) scan_arr_mem_5390)[sext_i32_i64(local_tid_5384)] =\n                0;\n        }\n    }\n    barrier(CLK_LOCAL_MEM_FENCE);\n    \n    int32_t x_5184;\n    bool x_5185;\n    int32_t x_5186;\n    bool x_5187;\n    int32_t x_5394;\n    bool x_5395;\n    int32_t x_5396;\n    bool x_5397;\n    bool ltid_in_bounds_5400;\n    \n    ltid_in_bounds_5400 = slt64(sext_i32_i64(local_tid_5384),\n                                stag",
                   "e1_num_groups_5340);\n    \n    int32_t skip_threads_5401;\n    \n    // read input for in-block scan\n    {\n        if (ltid_in_bounds_5400) {\n            x_5186 = ((volatile __local\n                       int32_t *) scan_arr_mem_5388)[sext_i32_i64(local_tid_5384)];\n            x_5187 = ((volatile __local\n                       bool *) scan_arr_mem_5390)[sext_i32_i64(local_tid_5384)];\n            if ((local_tid_5384 - squot32(local_tid_5384, 32) * 32) == 0) {\n                x_5184 = x_5186;\n                x_5185 = x_5187;\n            }\n        }\n    }\n    // in-block scan (hopefully no barriers needed)\n    {\n        skip_threads_5401 = 1;\n        while (slt32(skip_threads_5401, 32)) {\n            if (sle32(skip_threads_5401, local_tid_5384 -\n                      squot32(local_tid_5384, 32) * 32) &&\n                ltid_in_bounds_5400) {\n                // read operands\n                {\n                    x_5184 = ((volatile __local\n                               int32_t *) scan_arr_mem_5388)[sext_i32_i64(local_tid_5384) -\n                                                             sext_i32_i64(skip_threads_5401)];\n                    x_5185 = ((volatile __local\n                               bool *) scan_arr_mem_5390)[sext_i32_i64(local_tid_5384) -\n                                                          sext_i32_i64(skip_threads_5401)];\n                }\n                // perform operation\n                {\n                    int32_t defunc_res_5188;\n                    \n                    if (x_5187) {\n                        defunc_res_5188 = x_5186;\n                    } else {\n                        int32_t defunc_1_op_res_5189 = add32(x_5184, x_5186);\n                        \n                        defunc_res_5188 = defunc_1_op_res_5189;\n                    }\n                    x_5184 = defunc_res_5188;\n                    x_5185 = x_5187;\n                }\n            }\n            if (sle32(wave_sizze_5386, skip_threads_5401)) {\n                barr",
                   "ier(CLK_LOCAL_MEM_FENCE);\n            }\n            if (sle32(skip_threads_5401, local_tid_5384 -\n                      squot32(local_tid_5384, 32) * 32) &&\n                ltid_in_bounds_5400) {\n                // write result\n                {\n                    ((volatile __local\n                      int32_t *) scan_arr_mem_5388)[sext_i32_i64(local_tid_5384)] =\n                        x_5184;\n                    x_5186 = x_5184;\n                    ((volatile __local\n                      bool *) scan_arr_mem_5390)[sext_i32_i64(local_tid_5384)] =\n                        x_5185;\n                    x_5187 = x_5185;\n                }\n            }\n            if (sle32(wave_sizze_5386, skip_threads_5401)) {\n                barrier(CLK_LOCAL_MEM_FENCE);\n            }\n            skip_threads_5401 *= 2;\n        }\n    }\n    barrier(CLK_LOCAL_MEM_FENCE);\n    // last thread of block 'i' writes its result to offset 'i'\n    {\n        if ((local_tid_5384 - squot32(local_tid_5384, 32) * 32) == 31 &&\n            ltid_in_bounds_5400) {\n            ((volatile __local\n              int32_t *) scan_arr_mem_5388)[sext_i32_i64(squot32(local_tid_5384,\n                                                                 32))] = x_5184;\n            ((volatile __local\n              bool *) scan_arr_mem_5390)[sext_i32_i64(squot32(local_tid_5384,\n                                                              32))] = x_5185;\n        }\n    }\n    barrier(CLK_LOCAL_MEM_FENCE);\n    // scan the first block, after which offset 'i' contains carry-in for block 'i+1'\n    {\n        int32_t skip_threads_5402;\n        \n        // read input for in-block scan\n        {\n            if (squot32(local_tid_5384, 32) == 0 && ltid_in_bounds_5400) {\n                x_5396 = ((volatile __local\n                           int32_t *) scan_arr_mem_5388)[sext_i32_i64(local_tid_5384)];\n                x_5397 = ((volatile __local\n                           bool *) scan_arr_mem_5390)[sext_i32_i64(local_tid_5384)];\n    ",
                   "            if ((local_tid_5384 - squot32(local_tid_5384, 32) * 32) == 0) {\n                    x_5394 = x_5396;\n                    x_5395 = x_5397;\n                }\n            }\n        }\n        // in-block scan (hopefully no barriers needed)\n        {\n            skip_threads_5402 = 1;\n            while (slt32(skip_threads_5402, 32)) {\n                if (sle32(skip_threads_5402, local_tid_5384 -\n                          squot32(local_tid_5384, 32) * 32) &&\n                    (squot32(local_tid_5384, 32) == 0 && ltid_in_bounds_5400)) {\n                    // read operands\n                    {\n                        x_5394 = ((volatile __local\n                                   int32_t *) scan_arr_mem_5388)[sext_i32_i64(local_tid_5384) -\n                                                                 sext_i32_i64(skip_threads_5402)];\n                        x_5395 = ((volatile __local\n                                   bool *) scan_arr_mem_5390)[sext_i32_i64(local_tid_5384) -\n                                                              sext_i32_i64(skip_threads_5402)];\n                    }\n                    // perform operation\n                    {\n                        int32_t defunc_res_5398;\n                        \n                        if (x_5397) {\n                            defunc_res_5398 = x_5396;\n                        } else {\n                            int32_t defunc_1_op_res_5399 = add32(x_5394,\n                                                                 x_5396);\n                            \n                            defunc_res_5398 = defunc_1_op_res_5399;\n                        }\n                        x_5394 = defunc_res_5398;\n                        x_5395 = x_5397;\n                    }\n                }\n                if (sle32(wave_sizze_5386, skip_threads_5402)) {\n                    barrier(CLK_LOCAL_MEM_FENCE);\n                }\n                if (sle32(skip_threads_5402, local_tid_5384 -\n                       ",
                   "   squot32(local_tid_5384, 32) * 32) &&\n                    (squot32(local_tid_5384, 32) == 0 && ltid_in_bounds_5400)) {\n                    // write result\n                    {\n                        ((volatile __local\n                          int32_t *) scan_arr_mem_5388)[sext_i32_i64(local_tid_5384)] =\n                            x_5394;\n                        x_5396 = x_5394;\n                        ((volatile __local\n                          bool *) scan_arr_mem_5390)[sext_i32_i64(local_tid_5384)] =\n                            x_5395;\n                        x_5397 = x_5395;\n                    }\n                }\n                if (sle32(wave_sizze_5386, skip_threads_5402)) {\n                    barrier(CLK_LOCAL_MEM_FENCE);\n                }\n                skip_threads_5402 *= 2;\n            }\n        }\n    }\n    barrier(CLK_LOCAL_MEM_FENCE);\n    // carry-in for every block except the first\n    {\n        if (!(squot32(local_tid_5384, 32) == 0 || !ltid_in_bounds_5400)) {\n            // read operands\n            {\n                x_5186 = x_5184;\n                x_5187 = x_5185;\n                x_5184 = ((__local\n                           int32_t *) scan_arr_mem_5388)[sext_i32_i64(squot32(local_tid_5384,\n                                                                              32)) -\n                                                         (int64_t) 1];\n                x_5185 = ((__local\n                           bool *) scan_arr_mem_5390)[sext_i32_i64(squot32(local_tid_5384,\n                                                                           32)) -\n                                                      (int64_t) 1];\n            }\n            // perform operation\n            {\n                int32_t defunc_res_5188;\n                \n                if (x_5187) {\n                    defunc_res_5188 = x_5186;\n                } else {\n                    int32_t defunc_1_op_res_5189 = add32(x_5184, x_5186);\n                    \n                ",
                   "    defunc_res_5188 = defunc_1_op_res_5189;\n                }\n                x_5184 = defunc_res_5188;\n                x_5185 = x_5187;\n            }\n            // write final result\n            {\n                ((__local\n                  int32_t *) scan_arr_mem_5388)[sext_i32_i64(local_tid_5384)] =\n                    x_5184;\n                ((__local\n                  bool *) scan_arr_mem_5390)[sext_i32_i64(local_tid_5384)] =\n                    x_5185;\n            }\n        }\n    }\n    barrier(CLK_LOCAL_MEM_FENCE);\n    // restore correct values for first block\n    {\n        if (squot32(local_tid_5384, 32) == 0) {\n            ((__local\n              int32_t *) scan_arr_mem_5388)[sext_i32_i64(local_tid_5384)] =\n                x_5186;\n            ((__local bool *) scan_arr_mem_5390)[sext_i32_i64(local_tid_5384)] =\n                x_5187;\n        }\n    }\n    barrier(CLK_LOCAL_MEM_FENCE);\n    // threads in bounds write scanned carries\n    {\n        if (slt64(gtid_5249, implz2081U_5162)) {\n            ((__global int32_t *) mem_5318)[gtid_5249] = ((__local\n                                                           int32_t *) scan_arr_mem_5388)[sext_i32_i64(local_tid_5384)];\n            ((__global bool *) mem_5320)[gtid_5249] = ((__local\n                                                        bool *) scan_arr_mem_5390)[sext_i32_i64(local_tid_5384)];\n        }\n    }\n    // threads in bound read carries; others get neutral element\n    {\n        if (slt64(gtid_5249, implz2081U_5162)) {\n            ((__local\n              int64_t *) scan_arr_mem_5388)[sext_i32_i64(local_tid_5384)] =\n                ((__global int64_t *) mem_5322)[gtid_5249];\n        } else {\n            ((__local\n              int64_t *) scan_arr_mem_5388)[sext_i32_i64(local_tid_5384)] =\n                (int64_t) 0;\n        }\n    }\n    barrier(CLK_LOCAL_MEM_FENCE);\n    \n    int64_t x_5190;\n    int64_t y_5191;\n    int64_t x_5403;\n    int64_t y_5404;\n    bool ltid_in_bounds_5406;\n    \n    ltid_in_bounds_5",
                   "406 = slt64(sext_i32_i64(local_tid_5384),\n                                stage1_num_groups_5340);\n    \n    int32_t skip_threads_5407;\n    \n    // read input for in-block scan\n    {\n        if (ltid_in_bounds_5406) {\n            y_5191 = ((volatile __local\n                       int64_t *) scan_arr_mem_5388)[sext_i32_i64(local_tid_5384)];\n            if ((local_tid_5384 - squot32(local_tid_5384, 32) * 32) == 0) {\n                x_5190 = y_5191;\n            }\n        }\n    }\n    // in-block scan (hopefully no barriers needed)\n    {\n        skip_threads_5407 = 1;\n        while (slt32(skip_threads_5407, 32)) {\n            if (sle32(skip_threads_5407, local_tid_5384 -\n                      squot32(local_tid_5384, 32) * 32) &&\n                ltid_in_bounds_5406) {\n                // read operands\n                {\n                    x_5190 = ((volatile __local\n                               int64_t *) scan_arr_mem_5388)[sext_i32_i64(local_tid_5384) -\n                                                             sext_i32_i64(skip_threads_5407)];\n                }\n                // perform operation\n                {\n                    int64_t zz_5192 = x_5190 + y_5191;\n                    \n                    x_5190 = zz_5192;\n                }\n            }\n            if (sle32(wave_sizze_5386, skip_threads_5407)) {\n                barrier(CLK_LOCAL_MEM_FENCE);\n            }\n            if (sle32(skip_threads_5407, local_tid_5384 -\n                      squot32(local_tid_5384, 32) * 32) &&\n                ltid_in_bounds_5406) {\n                // write result\n                {\n                    ((volatile __local\n                      int64_t *) scan_arr_mem_5388)[sext_i32_i64(local_tid_5384)] =\n                        x_5190;\n                    y_5191 = x_5190;\n                }\n            }\n            if (sle32(wave_sizze_5386, skip_threads_5407)) {\n                barrier(CLK_LOCAL_MEM_FENCE);\n            }\n            skip_threads_5407 *= 2;\n        }\n    }",
                   "\n    barrier(CLK_LOCAL_MEM_FENCE);\n    // last thread of block 'i' writes its result to offset 'i'\n    {\n        if ((local_tid_5384 - squot32(local_tid_5384, 32) * 32) == 31 &&\n            ltid_in_bounds_5406) {\n            ((volatile __local\n              int64_t *) scan_arr_mem_5388)[sext_i32_i64(squot32(local_tid_5384,\n                                                                 32))] = x_5190;\n        }\n    }\n    barrier(CLK_LOCAL_MEM_FENCE);\n    // scan the first block, after which offset 'i' contains carry-in for block 'i+1'\n    {\n        int32_t skip_threads_5408;\n        \n        // read input for in-block scan\n        {\n            if (squot32(local_tid_5384, 32) == 0 && ltid_in_bounds_5406) {\n                y_5404 = ((volatile __local\n                           int64_t *) scan_arr_mem_5388)[sext_i32_i64(local_tid_5384)];\n                if ((local_tid_5384 - squot32(local_tid_5384, 32) * 32) == 0) {\n                    x_5403 = y_5404;\n                }\n            }\n        }\n        // in-block scan (hopefully no barriers needed)\n        {\n            skip_threads_5408 = 1;\n            while (slt32(skip_threads_5408, 32)) {\n                if (sle32(skip_threads_5408, local_tid_5384 -\n                          squot32(local_tid_5384, 32) * 32) &&\n                    (squot32(local_tid_5384, 32) == 0 && ltid_in_bounds_5406)) {\n                    // read operands\n                    {\n                        x_5403 = ((volatile __local\n                                   int64_t *) scan_arr_mem_5388)[sext_i32_i64(local_tid_5384) -\n                                                                 sext_i32_i64(skip_threads_5408)];\n                    }\n                    // perform operation\n                    {\n                        int64_t zz_5405 = x_5403 + y_5404;\n                        \n                        x_5403 = zz_5405;\n                    }\n                }\n                if (sle32(wave_sizze_5386, skip_threads_5408)) {\n            ",
                   "        barrier(CLK_LOCAL_MEM_FENCE);\n                }\n                if (sle32(skip_threads_5408, local_tid_5384 -\n                          squot32(local_tid_5384, 32) * 32) &&\n                    (squot32(local_tid_5384, 32) == 0 && ltid_in_bounds_5406)) {\n                    // write result\n                    {\n                        ((volatile __local\n                          int64_t *) scan_arr_mem_5388)[sext_i32_i64(local_tid_5384)] =\n                            x_5403;\n                        y_5404 = x_5403;\n                    }\n                }\n                if (sle32(wave_sizze_5386, skip_threads_5408)) {\n                    barrier(CLK_LOCAL_MEM_FENCE);\n                }\n                skip_threads_5408 *= 2;\n            }\n        }\n    }\n    barrier(CLK_LOCAL_MEM_FENCE);\n    // carry-in for every block except the first\n    {\n        if (!(squot32(local_tid_5384, 32) == 0 || !ltid_in_bounds_5406)) {\n            // read operands\n            {\n                y_5191 = x_5190;\n                x_5190 = ((__local\n                           int64_t *) scan_arr_mem_5388)[sext_i32_i64(squot32(local_tid_5384,\n                                                                              32)) -\n                                                         (int64_t) 1];\n            }\n            // perform operation\n            {\n                int64_t zz_5192 = x_5190 + y_5191;\n                \n                x_5190 = zz_5192;\n            }\n            // write final result\n            {\n                ((__local\n                  int64_t *) scan_arr_mem_5388)[sext_i32_i64(local_tid_5384)] =\n                    x_5190;\n            }\n        }\n    }\n    barrier(CLK_LOCAL_MEM_FENCE);\n    // restore correct values for first block\n    {\n        if (squot32(local_tid_5384, 32) == 0) {\n            ((__local\n              int64_t *) scan_arr_mem_5388)[sext_i32_i64(local_tid_5384)] =\n                y_5191;\n        }\n    }\n    barrier(CLK_LOCAL_MEM_FENCE);\n    // th",
                   "reads in bounds write scanned carries\n    {\n        if (slt64(gtid_5249, implz2081U_5162)) {\n            ((__global int64_t *) mem_5322)[gtid_5249] = ((__local\n                                                           int64_t *) scan_arr_mem_5388)[sext_i32_i64(local_tid_5384)];\n        }\n    }\n    \n  error_0:\n    return;\n    #undef segscan_group_sizze_5245\n}\n__kernel void mainziscan_stage3_5250(__global int *global_failure,\n                                     int64_t implz2081U_5162,\n                                     int64_t num_groups_5247,\n                                     int32_t num_threads_5341,\n                                     int32_t required_groups_5409, __global\n                                     unsigned char *mem_5318, __global\n                                     unsigned char *mem_5320, __global\n                                     unsigned char *mem_5322)\n{\n    #define segscan_group_sizze_5245 (mainzisegscan_group_sizze_5244)\n    \n    const int block_dim0 = 0;\n    const int block_dim1 = 1;\n    const int block_dim2 = 2;\n    \n    if (*global_failure >= 0)\n        return;\n    \n    int32_t global_tid_5410;\n    int32_t local_tid_5411;\n    int64_t group_sizze_5414;\n    int32_t wave_sizze_5413;\n    int32_t group_tid_5412;\n    \n    global_tid_5410 = get_global_id(0);\n    local_tid_5411 = get_local_id(0);\n    group_sizze_5414 = get_local_size(0);\n    wave_sizze_5413 = LOCKSTEP_WIDTH;\n    group_tid_5412 = get_group_id(0);\n    \n    int32_t phys_tid_5250;\n    \n    phys_tid_5250 = global_tid_5410;\n    \n    int32_t phys_group_id_5415;\n    \n    phys_group_id_5415 = get_group_id(0);\n    for (int32_t i_5416 = 0; i_5416 < sdiv_up32(required_groups_5409 -\n                                                phys_group_id_5415,\n                                                sext_i64_i32(num_groups_5247));\n         i_5416++) {\n        int32_t virt_group_id_5417 = phys_group_id_5415 + i_5416 *\n                sext_i64_i32(num_groups_5247);\n        int64_t flat_idx",
                   "_5418 = sext_i32_i64(virt_group_id_5417) *\n                segscan_group_sizze_5245 + sext_i32_i64(local_tid_5411);\n        int64_t gtid_5249 = flat_idx_5418;\n        int64_t orig_group_5419 = squot64(flat_idx_5418,\n                                          segscan_group_sizze_5245 *\n                                          sdiv_up64(implz2081U_5162,\n                                                    sext_i32_i64(num_threads_5341)));\n        int64_t carry_in_flat_idx_5420 = orig_group_5419 *\n                (segscan_group_sizze_5245 * sdiv_up64(implz2081U_5162,\n                                                      sext_i32_i64(num_threads_5341))) -\n                (int64_t) 1;\n        \n        if (slt64(gtid_5249, implz2081U_5162)) {\n            if (!(orig_group_5419 == (int64_t) 0 || flat_idx_5418 ==\n                  (orig_group_5419 + (int64_t) 1) * (segscan_group_sizze_5245 *\n                                                     sdiv_up64(implz2081U_5162,\n                                                               sext_i32_i64(num_threads_5341))) -\n                  (int64_t) 1)) {\n                int32_t x_5184;\n                bool x_5185;\n                int32_t x_5186;\n                bool x_5187;\n                \n                x_5184 = ((__global\n                           int32_t *) mem_5318)[carry_in_flat_idx_5420];\n                x_5185 = ((__global bool *) mem_5320)[carry_in_flat_idx_5420];\n                x_5186 = ((__global int32_t *) mem_5318)[gtid_5249];\n                x_5187 = ((__global bool *) mem_5320)[gtid_5249];\n                \n                int32_t defunc_res_5188;\n                \n                if (x_5187) {\n                    defunc_res_5188 = x_5186;\n                } else {\n                    int32_t defunc_1_op_res_5189 = add32(x_5184, x_5186);\n                    \n                    defunc_res_5188 = defunc_1_op_res_5189;\n                }\n                x_5184 = defunc_res_5188;\n                x_5185 = x_5187;\n       ",
                   "         ((__global int32_t *) mem_5318)[gtid_5249] = x_5184;\n                ((__global bool *) mem_5320)[gtid_5249] = x_5185;\n                \n                int64_t x_5190;\n                int64_t y_5191;\n                \n                x_5190 = ((__global\n                           int64_t *) mem_5322)[carry_in_flat_idx_5420];\n                y_5191 = ((__global int64_t *) mem_5322)[gtid_5249];\n                \n                int64_t zz_5192;\n                \n                zz_5192 = x_5190 + y_5191;\n                x_5190 = zz_5192;\n                ((__global int64_t *) mem_5322)[gtid_5249] = x_5190;\n            }\n        }\n        barrier(CLK_GLOBAL_MEM_FENCE | CLK_LOCAL_MEM_FENCE);\n    }\n    \n  error_0:\n    return;\n    #undef segscan_group_sizze_5245\n}\n__kernel void mainzisegmap_5252(__global int *global_failure,\n                                int64_t implz2081U_5162, __global\n                                unsigned char *mem_5322, __global\n                                unsigned char *mem_5324, __global\n                                unsigned char *mem_5326, __global\n                                unsigned char *mem_5328)\n{\n    #define segmap_group_sizze_5255 (mainzisegmap_group_sizze_5254)\n    \n    const int block_dim0 = 0;\n    const int block_dim1 = 1;\n    const int block_dim2 = 2;\n    \n    if (*global_failure >= 0)\n        return;\n    \n    int32_t global_tid_5421;\n    int32_t local_tid_5422;\n    int64_t group_sizze_5425;\n    int32_t wave_sizze_5424;\n    int32_t group_tid_5423;\n    \n    global_tid_5421 = get_global_id(0);\n    local_tid_5422 = get_local_id(0);\n    group_sizze_5425 = get_local_size(0);\n    wave_sizze_5424 = LOCKSTEP_WIDTH;\n    group_tid_5423 = get_group_id(0);\n    \n    int32_t phys_tid_5252;\n    \n    phys_tid_5252 = global_tid_5421;\n    \n    int64_t write_i_5251;\n    \n    write_i_5251 = sext_i32_i64(group_tid_5423) * segmap_group_sizze_5255 +\n        sext_i32_i64(local_tid_5422);\n    if (slt64(write_i_5251, implz2081U_5162)) {\n     ",
                   "   int64_t c_5216 = ((__global int64_t *) mem_5324)[write_i_5251];\n        int64_t offset_5217 = ((__global int64_t *) mem_5322)[write_i_5251];\n        int64_t v_5218 = ((__global int64_t *) mem_5326)[write_i_5251];\n        bool is_this_one_5220 = c_5216 == (int64_t) 0;\n        int64_t this_offset_5221 = (int64_t) -1 + offset_5217;\n        int64_t total_res_5222;\n        \n        if (is_this_one_5220) {\n            total_res_5222 = this_offset_5221;\n        } else {\n            total_res_5222 = (int64_t) -1;\n        }\n        if (sle64((int64_t) 0, total_res_5222) && slt64(total_res_5222,\n                                                        implz2081U_5162)) {\n            ((__global int64_t *) mem_5328)[total_res_5222] = v_5218;\n        }\n    }\n    \n  error_0:\n    return;\n    #undef segmap_group_sizze_5255\n}\n__kernel void mainzisegmap_5282(__global int *global_failure,\n                                int failure_is_an_option, __global\n                                int64_t *global_failure_args,\n                                int64_t implz2081U_5162,\n                                int64_t last_index_5210,\n                                int64_t partition_sizze_5212,\n                                int64_t conc_tmp_5234, __global\n                                unsigned char *mem_5318, __global\n                                unsigned char *mem_5328, __global\n                                unsigned char *mem_5332)\n{\n    #define segmap_group_sizze_5294 (mainzisegmap_group_sizze_5284)\n    \n    const int block_dim0 = 0;\n    const int block_dim1 = 1;\n    const int block_dim2 = 2;\n    \n    if (*global_failure >= 0)\n        return;\n    \n    int32_t global_tid_5426;\n    int32_t local_tid_5427;\n    int64_t group_sizze_5430;\n    int32_t wave_sizze_5429;\n    int32_t group_tid_5428;\n    \n    global_tid_5426 = get_global_id(0);\n    local_tid_5427 = get_local_id(0);\n    group_sizze_5430 = get_local_size(0);\n    wave_sizze_5429 = LOCKSTEP_WIDTH;\n    group_tid_5428 = get_grou",
                   "p_id(0);\n    \n    int32_t phys_tid_5282;\n    \n    phys_tid_5282 = global_tid_5426;\n    \n    int64_t gtid_5281;\n    \n    gtid_5281 = sext_i32_i64(group_tid_5428) * segmap_group_sizze_5294 +\n        sext_i32_i64(local_tid_5427);\n    if (slt64(gtid_5281, conc_tmp_5234)) {\n        bool index_concat_cmp_5306 = sle64(partition_sizze_5212, gtid_5281);\n        int64_t index_concat_branch_5310;\n        \n        if (index_concat_cmp_5306) {\n            index_concat_branch_5310 = last_index_5210;\n        } else {\n            int64_t index_concat_5309 = ((__global\n                                          int64_t *) mem_5328)[gtid_5281];\n            \n            index_concat_branch_5310 = index_concat_5309;\n        }\n        \n        bool x_5298 = sle64((int64_t) 0, index_concat_branch_5310);\n        bool y_5299 = slt64(index_concat_branch_5310, implz2081U_5162);\n        bool bounds_check_5300 = x_5298 && y_5299;\n        bool index_certs_5301;\n        \n        if (!bounds_check_5300) {\n            {\n                if (atomic_cmpxchg_i32_global(global_failure, -1, 0) == -1) {\n                    global_failure_args[0] = index_concat_branch_5310;\n                    global_failure_args[1] = implz2081U_5162;\n                    ;\n                }\n                return;\n            }\n        }\n        \n        int32_t defunc_0_f_res_5302 = ((__global\n                                        int32_t *) mem_5318)[index_concat_branch_5310];\n        \n        ((__global int32_t *) mem_5332)[gtid_5281] = defunc_0_f_res_5302;\n    }\n    \n  error_0:\n    return;\n    #undef segmap_group_sizze_5294\n}\n",
                   NULL};
static const char *size_names[] = {"main.segmap_group_size_5254",
                                   "main.segmap_group_size_5284",
                                   "main.segscan_group_size_5244",
                                   "main.segscan_num_groups_5246"};
static const char *size_vars[] = {"mainzisegmap_group_sizze_5254",
                                  "mainzisegmap_group_sizze_5284",
                                  "mainzisegscan_group_sizze_5244",
                                  "mainzisegscan_num_groups_5246"};
static const char *size_classes[] = {"group_size", "group_size", "group_size",
                                     "num_groups"};
struct sizes {
    int64_t mainzisegmap_group_sizze_5254;
    int64_t mainzisegmap_group_sizze_5284;
    int64_t mainzisegscan_group_sizze_5244;
    int64_t mainzisegscan_num_groups_5246;
} ;
struct futhark_context_config {
...
struct futhark_context {
    ...
    int total_runs;
    long total_runtime;
    cl_kernel mainziscan_stage1_5250;
    cl_kernel mainziscan_stage2_5250;
    cl_kernel mainziscan_stage3_5250;
    cl_kernel mainzisegmap_5252;
    cl_kernel mainzisegmap_5282;
    ...
    int64_t mainziscan_stage1_5250_total_runtime;
    int mainziscan_stage1_5250_runs;
    int64_t mainziscan_stage2_5250_total_runtime;
    int mainziscan_stage2_5250_runs;
    int64_t mainziscan_stage3_5250_total_runtime;
    int mainziscan_stage3_5250_runs;
    int64_t mainzisegmap_5252_total_runtime;
    int mainzisegmap_5252_runs;
    int64_t mainzisegmap_5282_total_runtime;
    int mainzisegmap_5282_runs;
                               ...
                               struct futhark_context *ctx)
{
    ...
    ctx->mainziscan_stage1_5250_total_runtime = 0;
    ctx->mainziscan_stage1_5250_runs = 0;
    ctx->mainziscan_stage2_5250_total_runtime = 0;
    ctx->mainziscan_stage2_5250_runs = 0;
    ctx->mainziscan_stage3_5250_total_runtime = 0;
    ctx->mainziscan_stage3_5250_runs = 0;
    ctx->mainzisegmap_5252_total_runtime = 0;
    ctx->mainzisegmap_5252_runs = 0;
    ctx->mainzisegmap_5282_total_runtime = 0;
    ctx->mainzisegmap_5282_runs = 0;
}
                             ...
                             struct futhark_context *ctx, cl_program prog)
{
    ...
    OPENCL_SUCCEED_OR_RETURN(error);
    {
        ctx->mainziscan_stage1_5250 = clCreateKernel(prog,
                                                     "mainziscan_stage1_5250",
                                                     &error);
        OPENCL_SUCCEED_FATAL(error);
        OPENCL_SUCCEED_FATAL(clSetKernelArg(ctx->mainziscan_stage1_5250, 0,
                                            sizeof(cl_mem),
                                            &ctx->global_failure));
        if (ctx->debugging)
            fprintf(ctx->log, "Created kernel %s.\n", "main.scan_stage1_5250");
    }
    {
        ctx->mainziscan_stage2_5250 = clCreateKernel(prog,
                                                     "mainziscan_stage2_5250",
                                                     &error);
        OPENCL_SUCCEED_FATAL(error);
        OPENCL_SUCCEED_FATAL(clSetKernelArg(ctx->mainziscan_stage2_5250, 0,
                                            sizeof(cl_mem),
                                            &ctx->global_failure));
        if (ctx->debugging)
            fprintf(ctx->log, "Created kernel %s.\n", "main.scan_stage2_5250");
    }
    {
        ctx->mainziscan_stage3_5250 = clCreateKernel(prog,
                                                     "mainziscan_stage3_5250",
                                                     &error);
        OPENCL_SUCCEED_FATAL(error);
        OPENCL_SUCCEED_FATAL(clSetKernelArg(ctx->mainziscan_stage3_5250, 0,
                                            sizeof(cl_mem),
                                            &ctx->global_failure));
        if (ctx->debugging)
            fprintf(ctx->log, "Created kernel %s.\n", "main.scan_stage3_5250");
    }
    {
        ctx->mainzisegmap_5252 = clCreateKernel(prog, "mainzisegmap_5252",
                                                &error);
        OPENCL_SUCCEED_FATAL(error);
        OPENCL_SUCCEED_FATAL(clSetKernelArg(ctx->mainzisegmap_5252, 0,
                                            sizeof(cl_mem),
                                            &ctx->global_failure));
        if (ctx->debugging)
            fprintf(ctx->log, "Created kernel %s.\n", "main.segmap_5252");
    ...
    {
        ctx->mainzisegmap_5282 = clCreateKernel(prog, "mainzisegmap_5282",
                                                &error);
        OPENCL_SUCCEED_FATAL(error);
        OPENCL_SUCCEED_FATAL(clSetKernelArg(ctx->mainzisegmap_5282, 0,
                                            sizeof(cl_mem),
                                            &ctx->global_failure));
        OPENCL_SUCCEED_FATAL(clSetKernelArg(ctx->mainzisegmap_5282, 2,
                                            sizeof(cl_mem),
                                            &ctx->global_failure_args));
        if (ctx->debugging)
            fprintf(ctx->log, "Created kernel %s.\n", "main.segmap_5282");
    }
    ctx->sizes.mainzisegmap_group_sizze_5254 = cfg->sizes[0];
    ctx->sizes.mainzisegmap_group_sizze_5284 = cfg->sizes[1];
    ctx->sizes.mainzisegscan_group_sizze_5244 = cfg->sizes[2];
    ctx->sizes.mainzisegscan_num_groups_5246 = cfg->sizes[3];
    init_constants(ctx);
...
void futhark_context_free(struct futhark_context *ctx)
{
    free_constants(ctx);
    free_lock(&ctx->lock);
    OPENCL_SUCCEED_FATAL(clReleaseKernel(ctx->mainziscan_stage1_5250));
    OPENCL_SUCCEED_FATAL(clReleaseKernel(ctx->mainziscan_stage2_5250));
    OPENCL_SUCCEED_FATAL(clReleaseKernel(ctx->mainziscan_stage3_5250));
    OPENCL_SUCCEED_FATAL(clReleaseKernel(ctx->mainzisegmap_5252));
    OPENCL_SUCCEED_FATAL(clReleaseKernel(ctx->mainzisegmap_5282));
    ...
    if (failure_idx >= 0) {
        ...
        switch (failure_idx) {
          ...
          case 0:
            {
                ctx->error =
                    msgprintf("Index [%lld] out of bounds for array of shape [%lld].\n-> #0  exercise_2_2_2.fut:15:14-18\n   #1  exercise_2_2_2.fut:15:3-22\n   #2  exercise_2_2_2.fut:21:8-30\n   #3  exercise_2_2_2.fut:36:3-29\n   #4  exercise_2_2_2.fut:35:1-36:29\n",
                              args[0], args[1]);
                break;
            }
        }
...
char *futhark_context_report(struct futhark_context *ctx)
{
    ...
    if (ctx->profiling) {
        ...
        str_builder(&builder,
                    "main.scan_stage1_5250 ran %5d times; avg: %8ldus; total: %8ldus\n",
                    ctx->mainziscan_stage1_5250_runs,
                    (long) ctx->mainziscan_stage1_5250_total_runtime /
                    (ctx->mainziscan_stage1_5250_runs !=
                     0 ? ctx->mainziscan_stage1_5250_runs : 1),
                    (long) ctx->mainziscan_stage1_5250_total_runtime);
        ctx->total_runtime += ctx->mainziscan_stage1_5250_total_runtime;
        ctx->total_runs += ctx->mainziscan_stage1_5250_runs;
        str_builder(&builder,
                    "main.scan_stage2_5250 ran %5d times; avg: %8ldus; total: %8ldus\n",
                    ctx->mainziscan_stage2_5250_runs,
                    (long) ctx->mainziscan_stage2_5250_total_runtime /
                    (ctx->mainziscan_stage2_5250_runs !=
                     0 ? ctx->mainziscan_stage2_5250_runs : 1),
                    (long) ctx->mainziscan_stage2_5250_total_runtime);
        ctx->total_runtime += ctx->mainziscan_stage2_5250_total_runtime;
        ctx->total_runs += ctx->mainziscan_stage2_5250_runs;
        str_builder(&builder,
                    "main.scan_stage3_5250 ran %5d times; avg: %8ldus; total: %8ldus\n",
                    ctx->mainziscan_stage3_5250_runs,
                    (long) ctx->mainziscan_stage3_5250_total_runtime /
                    (ctx->mainziscan_stage3_5250_runs !=
                     0 ? ctx->mainziscan_stage3_5250_runs : 1),
                    (long) ctx->mainziscan_stage3_5250_total_runtime);
        ctx->total_runtime += ctx->mainziscan_stage3_5250_total_runtime;
        ctx->total_runs += ctx->mainziscan_stage3_5250_runs;
        str_builder(&builder,
                    "main.segmap_5252      ran %5d times; avg: %8ldus; total: %8ldus\n",
                    ctx->mainzisegmap_5252_runs,
                    (long) ctx->mainzisegmap_5252_total_runtime /
                    (ctx->mainzisegmap_5252_runs !=
                     0 ? ctx->mainzisegmap_5252_runs : 1),
                    (long) ctx->mainzisegmap_5252_total_runtime);
        ctx->total_runtime += ctx->mainzisegmap_5252_total_runtime;
        ctx->total_runs += ctx->mainzisegmap_5252_runs;
        str_builder(&builder,
                    "main.segmap_5282      ran %5d times; avg: %8ldus; total: %8ldus\n",
                    ctx->mainzisegmap_5282_runs,
                    (long) ctx->mainzisegmap_5282_total_runtime /
                    (ctx->mainzisegmap_5282_runs !=
                     0 ? ctx->mainzisegmap_5282_runs : 1),
                    (long) ctx->mainzisegmap_5282_total_runtime);
        ctx->total_runtime += ctx->mainzisegmap_5282_total_runtime;
        ctx->total_runs += ctx->mainzisegmap_5282_runs;
...
static int futrts_main(struct futhark_context *ctx,
                       struct memblock_device *out_mem_p_5431,
                       int64_t *out_out_arrsizze_5432,
                       struct memblock_device xs_mem_5314,
                       struct memblock_device ys_mem_5315,
                       int64_t implz2081U_5162);
                       ...
                       int64_t implz2081U_5162)
{
    ...
    int err = 0;
    struct memblock_device out_mem_5336;
    
    out_mem_5336.references = NULL;
    
    int64_t out_arrsizze_5337;
    int64_t segscan_group_sizze_5245;
    
    segscan_group_sizze_5245 = ctx->sizes.mainzisegscan_group_sizze_5244;
    
    int64_t num_groups_5247;
    int32_t max_num_groups_5338;
    
    max_num_groups_5338 = ctx->sizes.mainzisegscan_num_groups_5246;
    num_groups_5247 = sext_i64_i32(smax64((int64_t) 1,
                                          smin64(sdiv_up64(implz2081U_5162,
                                                           segscan_group_sizze_5245),
                                                 sext_i32_i64(max_num_groups_5338))));
    
    int64_t bytes_5317 = (int64_t) 4 * implz2081U_5162;
    struct memblock_device mem_5318;
    
    mem_5318.references = NULL;
    if (memblock_alloc_device(ctx, &mem_5318, bytes_5317, "mem_5318")) {
        err = 1;
        goto cleanup;
    }
    
    struct memblock_device mem_5320;
    
    mem_5320.references = NULL;
    if (memblock_alloc_device(ctx, &mem_5320, implz2081U_5162, "mem_5320")) {
        err = 1;
        goto cleanup;
    }
    
    int64_t bytes_5321 = (int64_t) 8 * implz2081U_5162;
    struct memblock_device mem_5322;
    
    mem_5322.references = NULL;
    if (memblock_alloc_device(ctx, &mem_5322, bytes_5321, "mem_5322")) {
        err = 1;
        goto cleanup;
    }
    
    struct memblock_device mem_5324;
    
    mem_5324.references = NULL;
    if (memblock_alloc_device(ctx, &mem_5324, bytes_5321, "mem_5324")) {
        err = 1;
        goto cleanup;
    }
    
    struct memblock_device mem_5326;
    
    mem_5326.references = NULL;
    if (memblock_alloc_device(ctx, &mem_5326, bytes_5321, "mem_5326")) {
        err = 1;
        goto cleanup;
    }
    if (slt64((int64_t) 0, implz2081U_5162)) {
        if (ctx->debugging)
            fprintf(ctx->log, "%s\n", "\n# SegScan");
        
        int64_t stage1_max_num_groups_5339;
        
        stage1_max_num_groups_5339 = ctx->opencl.max_group_size;
        
        int64_t stage1_num_groups_5340;
        
        stage1_num_groups_5340 = smin64(stage1_max_num_groups_5339,
                                        num_groups_5247);
        
        int32_t num_threads_5341;
        
        num_threads_5341 = sext_i64_i32(stage1_num_groups_5340 *
            segscan_group_sizze_5245);
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage1_5250, 1,
                                                smax64(smax64((int64_t) 1,
                                                              (int64_t) sizeof(int64_t) *
                                                              segscan_group_sizze_5245),
                                                       (int64_t) sizeof(int32_t) *
                                                       segscan_group_sizze_5245),
                                                NULL));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage1_5250, 2,
                                                smax64((int64_t) 1,
                                                       (int64_t) sizeof(bool) *
                                                       segscan_group_sizze_5245),
                                                NULL));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage1_5250, 3,
                                                sizeof(implz2081U_5162),
                                                &implz2081U_5162));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage1_5250, 4,
                                                sizeof(num_threads_5341),
                                                &num_threads_5341));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage1_5250, 5,
                                                sizeof(xs_mem_5314.mem),
                                                &xs_mem_5314.mem));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage1_5250, 6,
                                                sizeof(ys_mem_5315.mem),
                                                &ys_mem_5315.mem));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage1_5250, 7,
                                                sizeof(mem_5318.mem),
                                                &mem_5318.mem));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage1_5250, 8,
                                                sizeof(mem_5320.mem),
                                                &mem_5320.mem));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage1_5250, 9,
                                                sizeof(mem_5322.mem),
                                                &mem_5322.mem));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage1_5250, 10,
                                                sizeof(mem_5324.mem),
                                                &mem_5324.mem));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage1_5250, 11,
                                                sizeof(mem_5326.mem),
                                                &mem_5326.mem));
        if (1 * ((size_t) stage1_num_groups_5340 *
                 (size_t) segscan_group_sizze_5245) != 0) {
            const size_t global_work_sizze_5433[1] =
                         {(size_t) stage1_num_groups_5340 *
                         (size_t) segscan_group_sizze_5245};
            const size_t local_work_sizze_5437[1] = {segscan_group_sizze_5245};
            int64_t time_start_5434 = 0, time_end_5435 = 0;
            
            if (ctx->debugging) {
                fprintf(ctx->log, "Launching %s with global work size [",
                        "main.scan_stage1_5250");
                fprintf(ctx->log, "%zu", global_work_sizze_5433[0]);
                fprintf(ctx->log, "] and local work size [");
                fprintf(ctx->log, "%zu", local_work_sizze_5437[0]);
                fprintf(ctx->log,
                        "]; local memory parameters sum to %d bytes.\n",
                        (int) (0 + smax64(smax64((int64_t) 1,
                                                 (int64_t) sizeof(int64_t) *
                                                 segscan_group_sizze_5245),
                                          (int64_t) sizeof(int32_t) *
                                          segscan_group_sizze_5245) +
                               smax64((int64_t) 1, (int64_t) sizeof(bool) *
                                      segscan_group_sizze_5245)));
                time_start_5434 = get_wall_time();
            }
            OPENCL_SUCCEED_OR_RETURN(clEnqueueNDRangeKernel(ctx->opencl.queue,
                                                            ctx->mainziscan_stage1_5250,
                                                            1, NULL,
                                                            global_work_sizze_5433,
                                                            local_work_sizze_5437,
                                                            0, NULL,
                                                            ctx->profiling_paused ||
                                                            !ctx->profiling ? NULL : opencl_get_event(&ctx->opencl,
                                                                                                      &ctx->mainziscan_stage1_5250_runs,
                                                                                                      &ctx->mainziscan_stage1_5250_total_runtime)));
            if (ctx->debugging) {
                OPENCL_SUCCEED_FATAL(clFinish(ctx->opencl.queue));
                time_end_5435 = get_wall_time();
                
                long time_diff_5436 = time_end_5435 - time_start_5434;
                
                fprintf(ctx->log, "kernel %s runtime: %ldus\n",
                        "main.scan_stage1_5250", time_diff_5436);
            }
        }
        if (ctx->debugging)
            fprintf(ctx->log, "%s: %llu%c", "elems_per_group",
                    (long long) (segscan_group_sizze_5245 *
                                 sdiv_up64(implz2081U_5162,
                                           sext_i32_i64(num_threads_5341))),
                    '\n');
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage2_5250, 1,
                                                smax64(smax64((int64_t) 1,
                                                              (int64_t) sizeof(int64_t) *
                                                              stage1_num_groups_5340),
                                                       (int64_t) sizeof(int32_t) *
                                                       stage1_num_groups_5340),
                                                NULL));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage2_5250, 2,
                                                smax64((int64_t) 1,
                                                       (int64_t) sizeof(bool) *
                                                       stage1_num_groups_5340),
                                                NULL));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage2_5250, 3,
                                                sizeof(implz2081U_5162),
                                                &implz2081U_5162));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage2_5250, 4,
                                                sizeof(stage1_num_groups_5340),
                                                &stage1_num_groups_5340));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage2_5250, 5,
                                                sizeof(num_threads_5341),
                                                &num_threads_5341));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage2_5250, 6,
                                                sizeof(mem_5318.mem),
                                                &mem_5318.mem));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage2_5250, 7,
                                                sizeof(mem_5320.mem),
                                                &mem_5320.mem));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage2_5250, 8,
                                                sizeof(mem_5322.mem),
                                                &mem_5322.mem));
        if (1 * ((size_t) (int64_t) 1 * (size_t) stage1_num_groups_5340) != 0) {
            const size_t global_work_sizze_5438[1] = {(size_t) (int64_t) 1 *
                         (size_t) stage1_num_groups_5340};
            const size_t local_work_sizze_5442[1] = {stage1_num_groups_5340};
            int64_t time_start_5439 = 0, time_end_5440 = 0;
            
            if (ctx->debugging) {
                fprintf(ctx->log, "Launching %s with global work size [",
                        "main.scan_stage2_5250");
                fprintf(ctx->log, "%zu", global_work_sizze_5438[0]);
                fprintf(ctx->log, "] and local work size [");
                fprintf(ctx->log, "%zu", local_work_sizze_5442[0]);
                fprintf(ctx->log,
                        "]; local memory parameters sum to %d bytes.\n",
                        (int) (0 + smax64(smax64((int64_t) 1,
                                                 (int64_t) sizeof(int64_t) *
                               ...
                               smax64((int64_t) 1, (int64_t) sizeof(bool) *
                                      stage1_num_groups_5340)));
                time_start_5439 = get_wall_time();
            }
            OPENCL_SUCCEED_OR_RETURN(clEnqueueNDRangeKernel(ctx->opencl.queue,
                                                            ctx->mainziscan_stage2_5250,
                                                            1, NULL,
                                                            global_work_sizze_5438,
                                                            local_work_sizze_5442,
                                                            0, NULL,
                                                            ctx->profiling_paused ||
                                                            !ctx->profiling ? NULL : opencl_get_event(&ctx->opencl,
                                                                                                      &ctx->mainziscan_stage2_5250_runs,
                                                                                                      &ctx->mainziscan_stage2_5250_total_runtime)));
            if (ctx->debugging) {
                OPENCL_SUCCEED_FATAL(clFinish(ctx->opencl.queue));
                time_end_5440 = get_wall_time();
                
                long time_diff_5441 = time_end_5440 - time_start_5439;
                
                fprintf(ctx->log, "kernel %s runtime: %ldus\n",
                        "main.scan_stage2_5250", time_diff_5441);
            }
        }
        
        int32_t required_groups_5409;
        
        required_groups_5409 = sext_i64_i32(sdiv_up64(implz2081U_5162,
                                                      segscan_group_sizze_5245));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage3_5250, 1,
                                                sizeof(implz2081U_5162),
                                                &implz2081U_5162));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage3_5250, 2,
                                                sizeof(num_groups_5247),
                                                &num_groups_5247));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage3_5250, 3,
                                                sizeof(num_threads_5341),
                                                &num_threads_5341));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage3_5250, 4,
                                                sizeof(required_groups_5409),
                                                &required_groups_5409));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage3_5250, 5,
                                                sizeof(mem_5318.mem),
                                                &mem_5318.mem));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage3_5250, 6,
                                                sizeof(mem_5320.mem),
                                                &mem_5320.mem));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage3_5250, 7,
                                                sizeof(mem_5322.mem),
                                                &mem_5322.mem));
        if (1 * ((size_t) num_groups_5247 *
                 (size_t) segscan_group_sizze_5245) != 0) {
            const size_t global_work_sizze_5443[1] = {(size_t) num_groups_5247 *
                         (size_t) segscan_group_sizze_5245};
            const size_t local_work_sizze_5447[1] = {segscan_group_sizze_5245};
            int64_t time_start_5444 = 0, time_end_5445 = 0;
            
            if (ctx->debugging) {
                fprintf(ctx->log, "Launching %s with global work size [",
                        "main.scan_stage3_5250");
                fprintf(ctx->log, "%zu", global_work_sizze_5443[0]);
                fprintf(ctx->log, "] and local work size [");
                fprintf(ctx->log, "%zu", local_work_sizze_5447[0]);
                fprintf(ctx->log,
                        "]; local memory parameters sum to %d bytes.\n",
                        (int) 0);
                time_start_5444 = get_wall_time();
            }
            OPENCL_SUCCEED_OR_RETURN(clEnqueueNDRangeKernel(ctx->opencl.queue,
                                                            ctx->mainziscan_stage3_5250,
                                                            1, NULL,
                                                            global_work_sizze_5443,
                                                            local_work_sizze_5447,
                                                            0, NULL,
                                                            ctx->profiling_paused ||
                                                            !ctx->profiling ? NULL : opencl_get_event(&ctx->opencl,
                                                                                                      &ctx->mainziscan_stage3_5250_runs,
                                                                                                      &ctx->mainziscan_stage3_5250_total_runtime)));
            if (ctx->debugging) {
                OPENCL_SUCCEED_FATAL(clFinish(ctx->opencl.queue));
                time_end_5445 = get_wall_time();
                
                long time_diff_5446 = time_end_5445 - time_start_5444;
                
                fprintf(ctx->log, "kernel %s runtime: %ldus\n",
                        "main.scan_stage3_5250", time_diff_5446);
            }
        }
    }
    if (memblock_unref_device(ctx, &mem_5320, "mem_5320") != 0)
        return 1;
    
    int64_t last_index_5210 = implz2081U_5162 - (int64_t) 1;
    bool is_empty_5211 = implz2081U_5162 == (int64_t) 0;
    int64_t partition_sizze_5212;
    
    if (is_empty_5211) {
        partition_sizze_5212 = (int64_t) 0;
    } else {
        int64_t read_res_5448;
        ...
        int64_t last_offset_5213 = read_res_5448;
        
        partition_sizze_5212 = last_offset_5213;
    }
    
    struct memblock_device mem_5328;
    
    mem_5328.references = NULL;
    if (memblock_alloc_device(ctx, &mem_5328, bytes_5321, "mem_5328")) {
        err = 1;
        goto cleanup;
    }
    
    int64_t segmap_group_sizze_5255;
    
    segmap_group_sizze_5255 = ctx->sizes.mainzisegmap_group_sizze_5254;
    
    int64_t segmap_usable_groups_5256 = sdiv_up64(implz2081U_5162,
                                                  segmap_group_sizze_5255);
    
    if (ctx->debugging)
        fprintf(ctx->log, "%s\n", "\n# SegMap");
    OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainzisegmap_5252, 1,
                                            sizeof(implz2081U_5162),
                                            &implz2081U_5162));
    OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainzisegmap_5252, 2,
                                            sizeof(mem_5322.mem),
                                            &mem_5322.mem));
    OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainzisegmap_5252, 3,
                                            sizeof(mem_5324.mem),
                                            &mem_5324.mem));
    OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainzisegmap_5252, 4,
                                            sizeof(mem_5326.mem),
                                            &mem_5326.mem));
    OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainzisegmap_5252, 5,
                                            sizeof(mem_5328.mem),
                                            &mem_5328.mem));
    if (1 * ((size_t) segmap_usable_groups_5256 *
             (size_t) segmap_group_sizze_5255) != 0) {
        const size_t global_work_sizze_5449[1] =
                     {(size_t) segmap_usable_groups_5256 *
                     (size_t) segmap_group_sizze_5255};
        const size_t local_work_sizze_5453[1] = {segmap_group_sizze_5255};
        int64_t time_start_5450 = 0, time_end_5451 = 0;
        
        if (ctx->debugging) {
            fprintf(ctx->log, "Launching %s with global work size [",
                    "main.segmap_5252");
            fprintf(ctx->log, "%zu", global_work_sizze_5449[0]);
            fprintf(ctx->log, "] and local work size [");
            fprintf(ctx->log, "%zu", local_work_sizze_5453[0]);
            fprintf(ctx->log, "]; local memory parameters sum to %d bytes.\n",
                    (int) 0);
            time_start_5450 = get_wall_time();
        }
        OPENCL_SUCCEED_OR_RETURN(clEnqueueNDRangeKernel(ctx->opencl.queue,
                                                        ctx->mainzisegmap_5252,
                                                        1, NULL,
                                                        global_work_sizze_5449,
                                                        local_work_sizze_5453,
                                                        0, NULL,
                                                        ctx->profiling_paused ||
                                                        !ctx->profiling ? NULL : opencl_get_event(&ctx->opencl,
                                                                                                  &ctx->mainzisegmap_5252_runs,
                                                                                                  &ctx->mainzisegmap_5252_total_runtime)));
        if (ctx->debugging) {
            OPENCL_SUCCEED_FATAL(clFinish(ctx->opencl.queue));
            time_end_5451 = get_wall_time();
            
            long time_diff_5452 = time_end_5451 - time_start_5450;
            
            fprintf(ctx->log, "kernel %s runtime: %ldus\n", "main.segmap_5252",
                    time_diff_5452);
        }
    }
    if (memblock_unref_device(ctx, &mem_5322, "mem_5322") != 0)
        return 1;
    if (memblock_unref_device(ctx, &mem_5324, "mem_5324") != 0)
        return 1;
    if (memblock_unref_device(ctx, &mem_5326, "mem_5326") != 0)
        return 1;
    
    bool empty_slice_5223 = partition_sizze_5212 == (int64_t) 0;
    int64_t m_5224 = sub64(partition_sizze_5212, (int64_t) 1);
    bool zzero_leq_i_p_m_t_s_5225 = sle64((int64_t) 0, m_5224);
    bool i_p_m_t_s_leq_w_5226 = slt64(m_5224, implz2081U_5162);
    bool i_lte_j_5227 = sle64((int64_t) 0, partition_sizze_5212);
    bool y_5228 = zzero_leq_i_p_m_t_s_5225 && i_p_m_t_s_leq_w_5226;
    bool y_5229 = i_lte_j_5227 && y_5228;
    bool ok_or_empty_5230 = empty_slice_5223 || y_5229;
    bool index_certs_5231;
    
    if (!ok_or_empty_5230) {
        ctx->error = msgprintf("Error: %s%lld%s%lld%s\n\nBacktrace:\n%s",
                               "Index [:", partition_sizze_5212,
                               "] out of bounds for array of shape [",
                               implz2081U_5162, "].",
                               "-> #0  /prelude/soacs.fut:155:6-16\n   #1  exercise_2_2_2.fut:20:26-75\n   #2  exercise_2_2_2.fut:36:3-29\n   #3  exercise_2_2_2.fut:35:1-36:29\n");
        ...
        if (memblock_unref_device(ctx, &mem_5320, "mem_5320") != 0)
            return 1;
        if (memblock_unref_device(ctx, &mem_5318, "mem_5318") != 0)
            return 1;
        if (memblock_unref_device(ctx, &out_mem_5336, "out_mem_5336") != 0)
            return 1;
        return 1;
    }
    
    int64_t conc_tmp_5234 = (int64_t) 1 + partition_sizze_5212;
    int64_t segmap_group_sizze_5294;
    
    segmap_group_sizze_5294 = ctx->sizes.mainzisegmap_group_sizze_5284;
    
    int64_t segmap_usable_groups_5295 = sdiv_up64(conc_tmp_5234,
                                                  segmap_group_sizze_5294);
    int64_t bytes_5331 = (int64_t) 4 * conc_tmp_5234;
    struct memblock_device mem_5332;
    
    mem_5332.references = NULL;
    if (memblock_alloc_device(ctx, &mem_5332, bytes_5331, "mem_5332")) {
        err = 1;
        goto cleanup;
    }
    if (ctx->debugging)
        fprintf(ctx->log, "%s\n", "\n# SegMap");
    OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainzisegmap_5282, 1,
                                            sizeof(ctx->failure_is_an_option),
                                            &ctx->failure_is_an_option));
    OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainzisegmap_5282, 3,
                                            sizeof(implz2081U_5162),
                                            &implz2081U_5162));
    OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainzisegmap_5282, 4,
                                            sizeof(last_index_5210),
                                            &last_index_5210));
    OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainzisegmap_5282, 5,
                                            sizeof(partition_sizze_5212),
                                            &partition_sizze_5212));
    OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainzisegmap_5282, 6,
                                            sizeof(conc_tmp_5234),
                                            &conc_tmp_5234));
    OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainzisegmap_5282, 7,
                                            sizeof(mem_5318.mem),
                                            &mem_5318.mem));
    OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainzisegmap_5282, 8,
                                            sizeof(mem_5328.mem),
                                            &mem_5328.mem));
    OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainzisegmap_5282, 9,
                                            sizeof(mem_5332.mem),
                                            &mem_5332.mem));
    if (1 * ((size_t) segmap_usable_groups_5295 *
             (size_t) segmap_group_sizze_5294) != 0) {
        const size_t global_work_sizze_5454[1] =
                     {(size_t) segmap_usable_groups_5295 *
                     (size_t) segmap_group_sizze_5294};
        const size_t local_work_sizze_5458[1] = {segmap_group_sizze_5294};
        int64_t time_start_5455 = 0, time_end_5456 = 0;
        
        if (ctx->debugging) {
            fprintf(ctx->log, "Launching %s with global work size [",
                    "main.segmap_5282");
            fprintf(ctx->log, "%zu", global_work_sizze_5454[0]);
            fprintf(ctx->log, "] and local work size [");
            fprintf(ctx->log, "%zu", local_work_sizze_5458[0]);
            fprintf(ctx->log, "]; local memory parameters sum to %d bytes.\n",
                    (int) 0);
            time_start_5455 = get_wall_time();
        }
        OPENCL_SUCCEED_OR_RETURN(clEnqueueNDRangeKernel(ctx->opencl.queue,
                                                        ctx->mainzisegmap_5282,
                                                        1, NULL,
                                                        global_work_sizze_5454,
                                                        local_work_sizze_5458,
                                                        0, NULL,
                                                        ctx->profiling_paused ||
                                                        !ctx->profiling ? NULL : opencl_get_event(&ctx->opencl,
                                                                                                  &ctx->mainzisegmap_5282_runs,
                                                                                                  &ctx->mainzisegmap_5282_total_runtime)));
        if (ctx->debugging) {
            OPENCL_SUCCEED_FATAL(clFinish(ctx->opencl.queue));
            time_end_5456 = get_wall_time();
            
            long time_diff_5457 = time_end_5456 - time_start_5455;
    ...
    if (memblock_unref_device(ctx, &mem_5328, "mem_5328") != 0)
        return 1;
    out_arrsizze_5337 = conc_tmp_5234;
    if (memblock_set_device(ctx, &out_mem_5336, &mem_5332, "mem_5332") != 0)
        return 1;
    (*out_mem_p_5431).references = NULL;
    if (memblock_set_device(ctx, &*out_mem_p_5431, &out_mem_5336,
                            "out_mem_5336") != 0)
        return 1;
    *out_out_arrsizze_5432 = out_arrsizze_5337;
    if (memblock_unref_device(ctx, &mem_5332, "mem_5332") != 0)
        return 1;
    if (memblock_unref_device(ctx, &mem_5328, "mem_5328") != 0)
        return 1;
    if (memblock_unref_device(ctx, &mem_5326, "mem_5326") != 0)
                       ...
                       struct futhark_bool_1d *in1)
{
    ...
    xs_mem_5314.references = NULL;
    
    struct memblock_device ys_mem_5315;
    
    ys_mem_5315.references = NULL;
    ...
    lock_lock(&ctx->lock);
    xs_mem_5314 = in0->mem;
    implz2081U_5162 = in0->shape[0];
    ys_mem_5315 = in1->mem;
    implz2081U_5162 = in1->shape[0];
    if (!(implz2081U_5162 == in0->shape[0] && implz2081U_5162 ==
          in1->shape[0])) {
        ret = 1;
        if (!ctx->error)
            ctx->error =
        ...
        ret = futrts_main(ctx, &out_mem_5336, &out_arrsizze_5337, xs_mem_5314,
                          ys_mem_5315, implz2081U_5162);
        if (ret == 0) {
            assert((*out0 =
                    (struct futhark_i32_1d *) malloc(sizeof(struct futhark_i32_1d))) !=
                NULL);
            (*out0)->mem = out_mem_5336;
            (*out0)->shape[0] = out_arrsizze_5337;
        }
    }
    lock_unlock(&ctx->lock);
    return ret;
