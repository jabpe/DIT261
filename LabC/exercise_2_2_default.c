...
static const char *opencl_program[] =
                  {"#ifdef cl_clang_storage_class_specifiers\n#pragma OPENCL EXTENSION cl_clang_storage_class_specifiers : enable\n#endif\n#pragma OPENCL EXTENSION cl_khr_byte_addressable_store : enable\n__kernel void dummy_kernel(__global unsigned char *dummy, int n)\n{\n    const int thread_gid = get_global_id(0);\n    \n    if (thread_gid >= n)\n        return;\n}\n#pragma OPENCL EXTENSION cl_khr_int64_base_atomics : enable\n#pragma OPENCL EXTENSION cl_khr_int64_extended_atomics : enable\ntypedef char int8_t;\ntypedef short int16_t;\ntypedef int int32_t;\ntypedef long int64_t;\ntypedef uchar uint8_t;\ntypedef ushort uint16_t;\ntypedef uint uint32_t;\ntypedef ulong uint64_t;\n#ifdef cl_nv_pragma_unroll\nstatic inline void mem_fence_global()\n{\n    asm(\"membar.gl;\");\n}\n#else\nstatic inline void mem_fence_global()\n{\n    mem_fence(CLK_LOCAL_MEM_FENCE | CLK_GLOBAL_MEM_FENCE);\n}\n#endif\nstatic inline void mem_fence_local()\n{\n    mem_fence(CLK_LOCAL_MEM_FENCE);\n}\nstatic inline uint8_t add8(uint8_t x, uint8_t y)\n{\n    return x + y;\n}\nstatic inline uint16_t add16(uint16_t x, uint16_t y)\n{\n    return x + y;\n}\nstatic inline uint32_t add32(uint32_t x, uint32_t y)\n{\n    return x + y;\n}\nstatic inline uint64_t add64(uint64_t x, uint64_t y)\n{\n    return x + y;\n}\nstatic inline uint8_t sub8(uint8_t x, uint8_t y)\n{\n    return x - y;\n}\nstatic inline uint16_t sub16(uint16_t x, uint16_t y)\n{\n    return x - y;\n}\nstatic inline uint32_t sub32(uint32_t x, uint32_t y)\n{\n    return x - y;\n}\nstatic inline uint64_t sub64(uint64_t x, uint64_t y)\n{\n    return x - y;\n}\nstatic inline uint8_t mul8(uint8_t x, uint8_t y)\n{\n    return x * y;\n}\nstatic inline uint16_t mul16(uint16_t x, uint16_t y)\n{\n    return x * y;\n}\nstatic inline uint32_t mul32(uint32_t x, uint32_t y)\n{\n    return x * y;\n}\nstatic inline uint64_t mul64(uint64_t x, uint64_t y)\n{\n    return x * y;\n}\nstatic inline uint8_t udiv8(uint8_t x, uint8_t y)\n{\n    return x / y;\n}\nstatic inline uint16_t udiv16(uint16_t x, uint16_t y)\n{\n    return x / y;\n}\nstatic inline uint32_t udiv32(uint3",
                   ...
                   " int64_t x) {\n#ifdef FUTHARK_CUDA\n  return atomicAnd((int64_t*)p, x);\n#else\n  return atom_and(p, x);\n#endif\n}\n\ninline int64_t atomic_or_i64_global(volatile __global int64_t *p, int64_t x) {\n#ifdef FUTHARK_CUDA\n  return atomicOr((int64_t*)p, x);\n#else\n  return atom_or(p, x);\n#endif\n}\n\ninline int64_t atomic_or_i64_local(volatile __local int64_t *p, int64_t x) {\n#ifdef FUTHARK_CUDA\n  return atomicOr((int64_t*)p, x);\n#else\n  return atom_or(p, x);\n#endif\n}\n\ninline int64_t atomic_xor_i64_global(volatile __global int64_t *p, int64_t x) {\n#ifdef FUTHARK_CUDA\n  return atomicXor((int64_t*)p, x);\n#else\n  return atom_xor(p, x);\n#endif\n}\n\ninline int64_t atomic_xor_i64_local(volatile __local int64_t *p, int64_t x) {\n#ifdef FUTHARK_CUDA\n  return atomicXor((int64_t*)p, x);\n#else\n  return atom_xor(p, x);\n#endif\n}\n\n// End of atomics.h\n\n\n\n\n__kernel void mainziscan_stage1_4064(__global int *global_failure,\n                                     __local volatile\n                                     int64_t *scan_arr_mem_4082_backing_aligned_0,\n                                     int64_t implz2080U_4048,\n                                     int32_t num_threads_4076, __global\n                                     unsigned char *xs_mem_4066, __global\n                                     unsigned char *mem_4070)\n{\n    #define segscan_group_sizze_4059 (mainzisegscan_group_sizze_4058)\n    \n    const int block_dim0 = 0;\n    const int block_dim1 = 1;\n    const int block_dim2 = 2;\n    __local volatile char *restrict scan_arr_mem_4082_backing_0 =\n                          (__local volatile\n                           char *) scan_arr_mem_4082_backing_aligned_0;\n    \n    if (*global_failure >= 0)\n        return;\n    \n    int32_t global_tid_4077;\n    int32_t local_tid_4078;\n    int64_t group_sizze_4081;\n    int32_t wave_sizze_4080;\n    int32_t group_tid_4079;\n    \n    global_tid_4077 = get_global_id(0);\n    local_tid_4078 = get_local_id(0);\n    group_sizze_4081 = get_local_size(0);\n    wave_sizze_4080",
                   " = LOCKSTEP_WIDTH;\n    group_tid_4079 = get_group_id(0);\n    \n    int32_t phys_tid_4064;\n    \n    phys_tid_4064 = global_tid_4077;\n    \n    __local char *scan_arr_mem_4082;\n    \n    scan_arr_mem_4082 = (__local char *) scan_arr_mem_4082_backing_0;\n    \n    int32_t x_4053;\n    int32_t x_4054;\n    \n    x_4053 = 0;\n    for (int64_t j_4084 = 0; j_4084 < sdiv_up64(implz2080U_4048,\n                                                sext_i32_i64(num_threads_4076));\n         j_4084++) {\n        int64_t chunk_offset_4085 = segscan_group_sizze_4059 * j_4084 +\n                sext_i32_i64(group_tid_4079) * (segscan_group_sizze_4059 *\n                                                sdiv_up64(implz2080U_4048,\n                                                          sext_i32_i64(num_threads_4076)));\n        int64_t flat_idx_4086 = chunk_offset_4085 +\n                sext_i32_i64(local_tid_4078);\n        int64_t gtid_4063 = flat_idx_4086;\n        \n        // threads in bounds read input\n        {\n            if (slt64(gtid_4063, implz2080U_4048)) {\n                int32_t x_4056 = ((__global int32_t *) xs_mem_4066)[gtid_4063];\n                \n                // write to-scan values to parameters\n                {\n                    x_4054 = x_4056;\n                }\n                // write mapped values results to global memory\n                { }\n            }\n        }\n        // do one intra-group scan operation\n        {\n            // maybe restore some to-scan values to parameters, or read neutral\n            {\n                if (!slt64(gtid_4063, implz2080U_4048)) {\n                    x_4054 = 0;\n                }\n            }\n            // combine with carry and write to local memory\n            {\n                int32_t defunc_1_op_res_4055 = add32(x_4053, x_4054);\n                \n                ((__local\n                  int32_t *) scan_arr_mem_4082)[sext_i32_i64(local_tid_4078)] =\n                    defunc_1_op_res_4055;\n            }\n            barrier(CLK_LO",
                   "CAL_MEM_FENCE);\n            \n            int32_t x_4087;\n            int32_t x_4088;\n            int32_t x_4090;\n            int32_t x_4091;\n            bool ltid_in_bounds_4093;\n            \n            ltid_in_bounds_4093 = slt64(sext_i32_i64(local_tid_4078),\n                                        segscan_group_sizze_4059);\n            \n            int32_t skip_threads_4094;\n            \n            // read input for in-block scan\n            {\n                if (ltid_in_bounds_4093) {\n                    x_4088 = ((volatile __local\n                               int32_t *) scan_arr_mem_4082)[sext_i32_i64(local_tid_4078)];\n                    if ((local_tid_4078 - squot32(local_tid_4078, 32) * 32) ==\n                        0) {\n                        x_4087 = x_4088;\n                    }\n                }\n            }\n            // in-block scan (hopefully no barriers needed)\n            {\n                skip_threads_4094 = 1;\n                while (slt32(skip_threads_4094, 32)) {\n                    if (sle32(skip_threads_4094, local_tid_4078 -\n                              squot32(local_tid_4078, 32) * 32) &&\n                        ltid_in_bounds_4093) {\n                        // read operands\n                        {\n                            x_4087 = ((volatile __local\n                                       int32_t *) scan_arr_mem_4082)[sext_i32_i64(local_tid_4078) -\n                                                                     sext_i32_i64(skip_threads_4094)];\n                        }\n                        // perform operation\n                        {\n                            int32_t defunc_1_op_res_4089 = add32(x_4087,\n                                                                 x_4088);\n                            \n                            x_4087 = defunc_1_op_res_4089;\n                        }\n                    }\n                    if (sle32(wave_sizze_4080, skip_threads_4094)) {\n                        barrier(CLK_LOC",
                   "AL_MEM_FENCE);\n                    }\n                    if (sle32(skip_threads_4094, local_tid_4078 -\n                              squot32(local_tid_4078, 32) * 32) &&\n                        ltid_in_bounds_4093) {\n                        // write result\n                        {\n                            ((volatile __local\n                              int32_t *) scan_arr_mem_4082)[sext_i32_i64(local_tid_4078)] =\n                                x_4087;\n                            x_4088 = x_4087;\n                        }\n                    }\n                    if (sle32(wave_sizze_4080, skip_threads_4094)) {\n                        barrier(CLK_LOCAL_MEM_FENCE);\n                    }\n                    skip_threads_4094 *= 2;\n                }\n            }\n            barrier(CLK_LOCAL_MEM_FENCE);\n            // last thread of block 'i' writes its result to offset 'i'\n            {\n                if ((local_tid_4078 - squot32(local_tid_4078, 32) * 32) == 31 &&\n                    ltid_in_bounds_4093) {\n                    ((volatile __local\n                      int32_t *) scan_arr_mem_4082)[sext_i32_i64(squot32(local_tid_4078,\n                                                                         32))] =\n                        x_4087;\n                }\n            }\n            barrier(CLK_LOCAL_MEM_FENCE);\n            // scan the first block, after which offset 'i' contains carry-in for block 'i+1'\n            {\n                int32_t skip_threads_4095;\n                \n                // read input for in-block scan\n                {\n                    if (squot32(local_tid_4078, 32) == 0 &&\n                        ltid_in_bounds_4093) {\n                        x_4091 = ((volatile __local\n                                   int32_t *) scan_arr_mem_4082)[sext_i32_i64(local_tid_4078)];\n                        if ((local_tid_4078 - squot32(local_tid_4078, 32) *\n                             32) == 0) {\n                            x_4090 = x_4091;\n      ",
                   "                  }\n                    }\n                }\n                // in-block scan (hopefully no barriers needed)\n                {\n                    skip_threads_4095 = 1;\n                    while (slt32(skip_threads_4095, 32)) {\n                        if (sle32(skip_threads_4095, local_tid_4078 -\n                                  squot32(local_tid_4078, 32) * 32) &&\n                            (squot32(local_tid_4078, 32) == 0 &&\n                             ltid_in_bounds_4093)) {\n                            // read operands\n                            {\n                                x_4090 = ((volatile __local\n                                           int32_t *) scan_arr_mem_4082)[sext_i32_i64(local_tid_4078) -\n                                                                         sext_i32_i64(skip_threads_4095)];\n                            }\n                            // perform operation\n                            {\n                                int32_t defunc_1_op_res_4092 = add32(x_4090,\n                                                                     x_4091);\n                                \n                                x_4090 = defunc_1_op_res_4092;\n                            }\n                        }\n                        if (sle32(wave_sizze_4080, skip_threads_4095)) {\n                            barrier(CLK_LOCAL_MEM_FENCE);\n                        }\n                        if (sle32(skip_threads_4095, local_tid_4078 -\n                                  squot32(local_tid_4078, 32) * 32) &&\n                            (squot32(local_tid_4078, 32) == 0 &&\n                             ltid_in_bounds_4093)) {\n                            // write result\n                            {\n                                ((volatile __local\n                                  int32_t *) scan_arr_mem_4082)[sext_i32_i64(local_tid_4078)] =\n                                    x_4090;\n                                x_4091 = x_4090;\n     ",
                   "                       }\n                        }\n                        if (sle32(wave_sizze_4080, skip_threads_4095)) {\n                            barrier(CLK_LOCAL_MEM_FENCE);\n                        }\n                        skip_threads_4095 *= 2;\n                    }\n                }\n            }\n            barrier(CLK_LOCAL_MEM_FENCE);\n            // carry-in for every block except the first\n            {\n                if (!(squot32(local_tid_4078, 32) == 0 ||\n                      !ltid_in_bounds_4093)) {\n                    // read operands\n                    {\n                        x_4088 = x_4087;\n                        x_4087 = ((__local\n                                   int32_t *) scan_arr_mem_4082)[sext_i32_i64(squot32(local_tid_4078,\n                                                                                      32)) -\n                                                                 (int64_t) 1];\n                    }\n                    // perform operation\n                    {\n                        int32_t defunc_1_op_res_4089 = add32(x_4087, x_4088);\n                        \n                        x_4087 = defunc_1_op_res_4089;\n                    }\n                    // write final result\n                    {\n                        ((__local\n                          int32_t *) scan_arr_mem_4082)[sext_i32_i64(local_tid_4078)] =\n                            x_4087;\n                    }\n                }\n            }\n            barrier(CLK_LOCAL_MEM_FENCE);\n            // restore correct values for first block\n            {\n                if (squot32(local_tid_4078, 32) == 0) {\n                    ((__local\n                      int32_t *) scan_arr_mem_4082)[sext_i32_i64(local_tid_4078)] =\n                        x_4088;\n                }\n            }\n            barrier(CLK_LOCAL_MEM_FENCE);\n            // threads in bounds write partial scan result\n            {\n                if (slt64(gtid_4063, implz2080U_4048)) ",
                   "{\n                    ((__global int32_t *) mem_4070)[gtid_4063] = ((__local\n                                                                   int32_t *) scan_arr_mem_4082)[sext_i32_i64(local_tid_4078)];\n                }\n            }\n            barrier(CLK_LOCAL_MEM_FENCE);\n            // first thread reads last element as carry-in for next iteration\n            {\n                bool crosses_segment_4096 = 0;\n                bool should_load_carry_4097 = local_tid_4078 == 0 &&\n                     !crosses_segment_4096;\n                \n                if (should_load_carry_4097) {\n                    x_4053 = ((__local\n                               int32_t *) scan_arr_mem_4082)[segscan_group_sizze_4059 -\n                                                             (int64_t) 1];\n                }\n                if (!should_load_carry_4097) {\n                    x_4053 = 0;\n                }\n            }\n            barrier(CLK_LOCAL_MEM_FENCE);\n        }\n    }\n    \n  error_1:\n    return;\n    #undef segscan_group_sizze_4059\n}\n__kernel void mainziscan_stage2_4064(__global int *global_failure,\n                                     __local volatile\n                                     int64_t *scan_arr_mem_4103_backing_aligned_0,\n                                     int64_t implz2080U_4048,\n                                     int64_t stage1_num_groups_4075,\n                                     int32_t num_threads_4076, __global\n                                     unsigned char *mem_4070)\n{\n    #define segscan_group_sizze_4059 (mainzisegscan_group_sizze_4058)\n    \n    const int block_dim0 = 0;\n    const int block_dim1 = 1;\n    const int block_dim2 = 2;\n    __local volatile char *restrict scan_arr_mem_4103_backing_0 =\n                          (__local volatile\n                           char *) scan_arr_mem_4103_backing_aligned_0;\n    \n    if (*global_failure >= 0)\n        return;\n    \n    int32_t global_tid_4098;\n    int32_t local_tid_4099;\n    int64_t group_si",
                   "zze_4102;\n    int32_t wave_sizze_4101;\n    int32_t group_tid_4100;\n    \n    global_tid_4098 = get_global_id(0);\n    local_tid_4099 = get_local_id(0);\n    group_sizze_4102 = get_local_size(0);\n    wave_sizze_4101 = LOCKSTEP_WIDTH;\n    group_tid_4100 = get_group_id(0);\n    \n    int32_t phys_tid_4064;\n    \n    phys_tid_4064 = global_tid_4098;\n    \n    __local char *scan_arr_mem_4103;\n    \n    scan_arr_mem_4103 = (__local char *) scan_arr_mem_4103_backing_0;\n    \n    int64_t flat_idx_4105;\n    \n    flat_idx_4105 = (sext_i32_i64(local_tid_4099) + (int64_t) 1) *\n        (segscan_group_sizze_4059 * sdiv_up64(implz2080U_4048,\n                                              sext_i32_i64(num_threads_4076))) -\n        (int64_t) 1;\n    \n    int64_t gtid_4063;\n    \n    gtid_4063 = flat_idx_4105;\n    // threads in bound read carries; others get neutral element\n    {\n        if (slt64(gtid_4063, implz2080U_4048)) {\n            ((__local\n              int32_t *) scan_arr_mem_4103)[sext_i32_i64(local_tid_4099)] =\n                ((__global int32_t *) mem_4070)[gtid_4063];\n        } else {\n            ((__local\n              int32_t *) scan_arr_mem_4103)[sext_i32_i64(local_tid_4099)] = 0;\n        }\n    }\n    barrier(CLK_LOCAL_MEM_FENCE);\n    \n    int32_t x_4053;\n    int32_t x_4054;\n    int32_t x_4106;\n    int32_t x_4107;\n    bool ltid_in_bounds_4109;\n    \n    ltid_in_bounds_4109 = slt64(sext_i32_i64(local_tid_4099),\n                                stage1_num_groups_4075);\n    \n    int32_t skip_threads_4110;\n    \n    // read input for in-block scan\n    {\n        if (ltid_in_bounds_4109) {\n            x_4054 = ((volatile __local\n                       int32_t *) scan_arr_mem_4103)[sext_i32_i64(local_tid_4099)];\n            if ((local_tid_4099 - squot32(local_tid_4099, 32) * 32) == 0) {\n                x_4053 = x_4054;\n            }\n        }\n    }\n    // in-block scan (hopefully no barriers needed)\n    {\n        skip_threads_4110 = 1;\n        while (slt32(skip_threads_4110, 32)) {\n      ",
                   "      if (sle32(skip_threads_4110, local_tid_4099 -\n                      squot32(local_tid_4099, 32) * 32) &&\n                ltid_in_bounds_4109) {\n                // read operands\n                {\n                    x_4053 = ((volatile __local\n                               int32_t *) scan_arr_mem_4103)[sext_i32_i64(local_tid_4099) -\n                                                             sext_i32_i64(skip_threads_4110)];\n                }\n                // perform operation\n                {\n                    int32_t defunc_1_op_res_4055 = add32(x_4053, x_4054);\n                    \n                    x_4053 = defunc_1_op_res_4055;\n                }\n            }\n            if (sle32(wave_sizze_4101, skip_threads_4110)) {\n                barrier(CLK_LOCAL_MEM_FENCE);\n            }\n            if (sle32(skip_threads_4110, local_tid_4099 -\n                      squot32(local_tid_4099, 32) * 32) &&\n                ltid_in_bounds_4109) {\n                // write result\n                {\n                    ((volatile __local\n                      int32_t *) scan_arr_mem_4103)[sext_i32_i64(local_tid_4099)] =\n                        x_4053;\n                    x_4054 = x_4053;\n                }\n            }\n            if (sle32(wave_sizze_4101, skip_threads_4110)) {\n                barrier(CLK_LOCAL_MEM_FENCE);\n            }\n            skip_threads_4110 *= 2;\n        }\n    }\n    barrier(CLK_LOCAL_MEM_FENCE);\n    // last thread of block 'i' writes its result to offset 'i'\n    {\n        if ((local_tid_4099 - squot32(local_tid_4099, 32) * 32) == 31 &&\n            ltid_in_bounds_4109) {\n            ((volatile __local\n              int32_t *) scan_arr_mem_4103)[sext_i32_i64(squot32(local_tid_4099,\n                                                                 32))] = x_4053;\n        }\n    }\n    barrier(CLK_LOCAL_MEM_FENCE);\n    // scan the first block, after which offset 'i' contains carry-in for block 'i+1'\n    {\n        int32_t skip_threads_4111;\n       ",
                   " \n        // read input for in-block scan\n        {\n            if (squot32(local_tid_4099, 32) == 0 && ltid_in_bounds_4109) {\n                x_4107 = ((volatile __local\n                           int32_t *) scan_arr_mem_4103)[sext_i32_i64(local_tid_4099)];\n                if ((local_tid_4099 - squot32(local_tid_4099, 32) * 32) == 0) {\n                    x_4106 = x_4107;\n                }\n            }\n        }\n        // in-block scan (hopefully no barriers needed)\n        {\n            skip_threads_4111 = 1;\n            while (slt32(skip_threads_4111, 32)) {\n                if (sle32(skip_threads_4111, local_tid_4099 -\n                          squot32(local_tid_4099, 32) * 32) &&\n                    (squot32(local_tid_4099, 32) == 0 && ltid_in_bounds_4109)) {\n                    // read operands\n                    {\n                        x_4106 = ((volatile __local\n                                   int32_t *) scan_arr_mem_4103)[sext_i32_i64(local_tid_4099) -\n                                                                 sext_i32_i64(skip_threads_4111)];\n                    }\n                    // perform operation\n                    {\n                        int32_t defunc_1_op_res_4108 = add32(x_4106, x_4107);\n                        \n                        x_4106 = defunc_1_op_res_4108;\n                    }\n                }\n                if (sle32(wave_sizze_4101, skip_threads_4111)) {\n                    barrier(CLK_LOCAL_MEM_FENCE);\n                }\n                if (sle32(skip_threads_4111, local_tid_4099 -\n                          squot32(local_tid_4099, 32) * 32) &&\n                    (squot32(local_tid_4099, 32) == 0 && ltid_in_bounds_4109)) {\n                    // write result\n                    {\n                        ((volatile __local\n                          int32_t *) scan_arr_mem_4103)[sext_i32_i64(local_tid_4099)] =\n                            x_4106;\n                        x_4107 = x_4106;\n                    }\n        ",
                   "        }\n                if (sle32(wave_sizze_4101, skip_threads_4111)) {\n                    barrier(CLK_LOCAL_MEM_FENCE);\n                }\n                skip_threads_4111 *= 2;\n            }\n        }\n    }\n    barrier(CLK_LOCAL_MEM_FENCE);\n    // carry-in for every block except the first\n    {\n        if (!(squot32(local_tid_4099, 32) == 0 || !ltid_in_bounds_4109)) {\n            // read operands\n            {\n                x_4054 = x_4053;\n                x_4053 = ((__local\n                           int32_t *) scan_arr_mem_4103)[sext_i32_i64(squot32(local_tid_4099,\n                                                                              32)) -\n                                                         (int64_t) 1];\n            }\n            // perform operation\n            {\n                int32_t defunc_1_op_res_4055 = add32(x_4053, x_4054);\n                \n                x_4053 = defunc_1_op_res_4055;\n            }\n            // write final result\n            {\n                ((__local\n                  int32_t *) scan_arr_mem_4103)[sext_i32_i64(local_tid_4099)] =\n                    x_4053;\n            }\n        }\n    }\n    barrier(CLK_LOCAL_MEM_FENCE);\n    // restore correct values for first block\n    {\n        if (squot32(local_tid_4099, 32) == 0) {\n            ((__local\n              int32_t *) scan_arr_mem_4103)[sext_i32_i64(local_tid_4099)] =\n                x_4054;\n        }\n    }\n    barrier(CLK_LOCAL_MEM_FENCE);\n    // threads in bounds write scanned carries\n    {\n        if (slt64(gtid_4063, implz2080U_4048)) {\n            ((__global int32_t *) mem_4070)[gtid_4063] = ((__local\n                                                           int32_t *) scan_arr_mem_4103)[sext_i32_i64(local_tid_4099)];\n        }\n    }\n    \n  error_0:\n    return;\n    #undef segscan_group_sizze_4059\n}\n__kernel void mainziscan_stage3_4064(__global int *global_failure,\n                                     int64_t implz2080U_4048,\n                                   ",
                   "  int64_t num_groups_4061,\n                                     int32_t num_threads_4076,\n                                     int32_t required_groups_4112, __global\n                                     unsigned char *mem_4070)\n{\n    #define segscan_group_sizze_4059 (mainzisegscan_group_sizze_4058)\n    \n    const int block_dim0 = 0;\n    const int block_dim1 = 1;\n    const int block_dim2 = 2;\n    \n    if (*global_failure >= 0)\n        return;\n    \n    int32_t global_tid_4113;\n    int32_t local_tid_4114;\n    int64_t group_sizze_4117;\n    int32_t wave_sizze_4116;\n    int32_t group_tid_4115;\n    \n    global_tid_4113 = get_global_id(0);\n    local_tid_4114 = get_local_id(0);\n    group_sizze_4117 = get_local_size(0);\n    wave_sizze_4116 = LOCKSTEP_WIDTH;\n    group_tid_4115 = get_group_id(0);\n    \n    int32_t phys_tid_4064;\n    \n    phys_tid_4064 = global_tid_4113;\n    \n    int32_t phys_group_id_4118;\n    \n    phys_group_id_4118 = get_group_id(0);\n    for (int32_t i_4119 = 0; i_4119 < sdiv_up32(required_groups_4112 -\n                                                phys_group_id_4118,\n                                                sext_i64_i32(num_groups_4061));\n         i_4119++) {\n        int32_t virt_group_id_4120 = phys_group_id_4118 + i_4119 *\n                sext_i64_i32(num_groups_4061);\n        int64_t flat_idx_4121 = sext_i32_i64(virt_group_id_4120) *\n                segscan_group_sizze_4059 + sext_i32_i64(local_tid_4114);\n        int64_t gtid_4063 = flat_idx_4121;\n        int64_t orig_group_4122 = squot64(flat_idx_4121,\n                                          segscan_group_sizze_4059 *\n                                          sdiv_up64(implz2080U_4048,\n                                                    sext_i32_i64(num_threads_4076)));\n        int64_t carry_in_flat_idx_4123 = orig_group_4122 *\n                (segscan_group_sizze_4059 * sdiv_up64(implz2080U_4048,\n                                                      sext_i32_i64(num_threads_4076))) -\n         ",
                   "       (int64_t) 1;\n        \n        if (slt64(gtid_4063, implz2080U_4048)) {\n            if (!(orig_group_4122 == (int64_t) 0 || flat_idx_4121 ==\n                  (orig_group_4122 + (int64_t) 1) * (segscan_group_sizze_4059 *\n                                                     sdiv_up64(implz2080U_4048,\n                                                               sext_i32_i64(num_threads_4076))) -\n                  (int64_t) 1)) {\n                int32_t x_4053;\n                int32_t x_4054;\n                \n                x_4053 = ((__global\n                           int32_t *) mem_4070)[carry_in_flat_idx_4123];\n                x_4054 = ((__global int32_t *) mem_4070)[gtid_4063];\n                \n                int32_t defunc_1_op_res_4055;\n                \n                defunc_1_op_res_4055 = add32(x_4053, x_4054);\n                x_4053 = defunc_1_op_res_4055;\n                ((__global int32_t *) mem_4070)[gtid_4063] = x_4053;\n            }\n        }\n        barrier(CLK_GLOBAL_MEM_FENCE | CLK_LOCAL_MEM_FENCE);\n    }\n    \n  error_0:\n    return;\n    #undef segscan_group_sizze_4059\n}\n",
                   NULL};
static const char *size_names[] = {"main.segscan_group_size_4058",
                                   "main.segscan_num_groups_4060"};
static const char *size_vars[] = {"mainzisegscan_group_sizze_4058",
                                  "mainzisegscan_num_groups_4060"};
static const char *size_classes[] = {"group_size", "num_groups"};
struct sizes {
    int64_t mainzisegscan_group_sizze_4058;
    int64_t mainzisegscan_num_groups_4060;
} ;
struct futhark_context_config {
...
struct futhark_context {
    ...
    int total_runs;
    long total_runtime;
    cl_kernel mainziscan_stage1_4064;
    cl_kernel mainziscan_stage2_4064;
    cl_kernel mainziscan_stage3_4064;
    ...
    int64_t mainziscan_stage1_4064_total_runtime;
    int mainziscan_stage1_4064_runs;
    int64_t mainziscan_stage2_4064_total_runtime;
    int mainziscan_stage2_4064_runs;
    int64_t mainziscan_stage3_4064_total_runtime;
    int mainziscan_stage3_4064_runs;
                               ...
                               struct futhark_context *ctx)
{
    ...
    ctx->mainziscan_stage1_4064_total_runtime = 0;
    ctx->mainziscan_stage1_4064_runs = 0;
    ctx->mainziscan_stage2_4064_total_runtime = 0;
    ctx->mainziscan_stage2_4064_runs = 0;
    ctx->mainziscan_stage3_4064_total_runtime = 0;
    ctx->mainziscan_stage3_4064_runs = 0;
}
                             ...
                             struct futhark_context *ctx, cl_program prog)
{
    ...
    OPENCL_SUCCEED_OR_RETURN(error);
    {
        ctx->mainziscan_stage1_4064 = clCreateKernel(prog,
                                                     "mainziscan_stage1_4064",
                                                     &error);
        OPENCL_SUCCEED_FATAL(error);
        OPENCL_SUCCEED_FATAL(clSetKernelArg(ctx->mainziscan_stage1_4064, 0,
                                            sizeof(cl_mem),
                                            &ctx->global_failure));
        if (ctx->debugging)
            fprintf(ctx->log, "Created kernel %s.\n", "main.scan_stage1_4064");
    }
    {
        ctx->mainziscan_stage2_4064 = clCreateKernel(prog,
                                                     "mainziscan_stage2_4064",
                                                     &error);
        OPENCL_SUCCEED_FATAL(error);
        OPENCL_SUCCEED_FATAL(clSetKernelArg(ctx->mainziscan_stage2_4064, 0,
                                            sizeof(cl_mem),
                                            &ctx->global_failure));
        if (ctx->debugging)
            fprintf(ctx->log, "Created kernel %s.\n", "main.scan_stage2_4064");
    }
    {
        ctx->mainziscan_stage3_4064 = clCreateKernel(prog,
                                                     "mainziscan_stage3_4064",
                                                     &error);
        OPENCL_SUCCEED_FATAL(error);
        OPENCL_SUCCEED_FATAL(clSetKernelArg(ctx->mainziscan_stage3_4064, 0,
                                            sizeof(cl_mem),
                                            &ctx->global_failure));
        if (ctx->debugging)
            fprintf(ctx->log, "Created kernel %s.\n", "main.scan_stage3_4064");
    }
    ctx->sizes.mainzisegscan_group_sizze_4058 = cfg->sizes[0];
    ctx->sizes.mainzisegscan_num_groups_4060 = cfg->sizes[1];
    init_constants(ctx);
...
void futhark_context_free(struct futhark_context *ctx)
{
    free_constants(ctx);
    free_lock(&ctx->lock);
    OPENCL_SUCCEED_FATAL(clReleaseKernel(ctx->mainziscan_stage1_4064));
    OPENCL_SUCCEED_FATAL(clReleaseKernel(ctx->mainziscan_stage2_4064));
    OPENCL_SUCCEED_FATAL(clReleaseKernel(ctx->mainziscan_stage3_4064));
...
char *futhark_context_report(struct futhark_context *ctx)
{
    ...
    if (ctx->profiling) {
        ...
        str_builder(&builder,
                    "main.scan_stage1_4064 ran %5d times; avg: %8ldus; total: %8ldus\n",
                    ctx->mainziscan_stage1_4064_runs,
                    (long) ctx->mainziscan_stage1_4064_total_runtime /
                    (ctx->mainziscan_stage1_4064_runs !=
                     0 ? ctx->mainziscan_stage1_4064_runs : 1),
                    (long) ctx->mainziscan_stage1_4064_total_runtime);
        ctx->total_runtime += ctx->mainziscan_stage1_4064_total_runtime;
        ctx->total_runs += ctx->mainziscan_stage1_4064_runs;
        str_builder(&builder,
                    "main.scan_stage2_4064 ran %5d times; avg: %8ldus; total: %8ldus\n",
                    ctx->mainziscan_stage2_4064_runs,
                    (long) ctx->mainziscan_stage2_4064_total_runtime /
                    (ctx->mainziscan_stage2_4064_runs !=
                     0 ? ctx->mainziscan_stage2_4064_runs : 1),
                    (long) ctx->mainziscan_stage2_4064_total_runtime);
        ctx->total_runtime += ctx->mainziscan_stage2_4064_total_runtime;
        ctx->total_runs += ctx->mainziscan_stage2_4064_runs;
        str_builder(&builder,
                    "main.scan_stage3_4064 ran %5d times; avg: %8ldus; total: %8ldus\n",
                    ctx->mainziscan_stage3_4064_runs,
                    (long) ctx->mainziscan_stage3_4064_total_runtime /
                    (ctx->mainziscan_stage3_4064_runs !=
                     0 ? ctx->mainziscan_stage3_4064_runs : 1),
                    (long) ctx->mainziscan_stage3_4064_total_runtime);
        ctx->total_runtime += ctx->mainziscan_stage3_4064_total_runtime;
        ctx->total_runs += ctx->mainziscan_stage3_4064_runs;
...
static int futrts_main(struct futhark_context *ctx,
                       struct memblock_device *out_mem_p_4124,
                       struct memblock_device xs_mem_4066,
                       struct memblock_device ys_mem_4067,
                       int64_t implz2080U_4048, int64_t implz2081U_4049);
                       ...
                       int64_t implz2080U_4048, int64_t implz2081U_4049)
{
    ...
    int err = 0;
    struct memblock_device out_mem_4072;
    
    out_mem_4072.references = NULL;
    
    int64_t segscan_group_sizze_4059;
    
    segscan_group_sizze_4059 = ctx->sizes.mainzisegscan_group_sizze_4058;
    
    int64_t num_groups_4061;
    int32_t max_num_groups_4073;
    
    max_num_groups_4073 = ctx->sizes.mainzisegscan_num_groups_4060;
    num_groups_4061 = sext_i64_i32(smax64((int64_t) 1,
                                          smin64(sdiv_up64(implz2080U_4048,
                                                           segscan_group_sizze_4059),
                                                 sext_i32_i64(max_num_groups_4073))));
    
    int64_t bytes_4069 = (int64_t) 4 * implz2080U_4048;
    struct memblock_device mem_4070;
    
    mem_4070.references = NULL;
    if (memblock_alloc_device(ctx, &mem_4070, bytes_4069, "mem_4070")) {
        err = 1;
        goto cleanup;
    }
    if (slt64((int64_t) 0, implz2080U_4048)) {
        if (ctx->debugging)
            fprintf(ctx->log, "%s\n", "\n# SegScan");
        
        int64_t stage1_max_num_groups_4074;
        
        stage1_max_num_groups_4074 = ctx->opencl.max_group_size;
        
        int64_t stage1_num_groups_4075;
        
        stage1_num_groups_4075 = smin64(stage1_max_num_groups_4074,
                                        num_groups_4061);
        
        int32_t num_threads_4076;
        
        num_threads_4076 = sext_i64_i32(stage1_num_groups_4075 *
            segscan_group_sizze_4059);
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage1_4064, 1,
                                                smax64((int64_t) 1,
                                                       (int64_t) sizeof(int32_t) *
                                                       segscan_group_sizze_4059),
                                                NULL));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage1_4064, 2,
                                                sizeof(implz2080U_4048),
                                                &implz2080U_4048));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage1_4064, 3,
                                                sizeof(num_threads_4076),
                                                &num_threads_4076));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage1_4064, 4,
                                                sizeof(xs_mem_4066.mem),
                                                &xs_mem_4066.mem));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage1_4064, 5,
                                                sizeof(mem_4070.mem),
                                                &mem_4070.mem));
        if (1 * ((size_t) stage1_num_groups_4075 *
                 (size_t) segscan_group_sizze_4059) != 0) {
            const size_t global_work_sizze_4125[1] =
                         {(size_t) stage1_num_groups_4075 *
                         (size_t) segscan_group_sizze_4059};
            const size_t local_work_sizze_4129[1] = {segscan_group_sizze_4059};
            int64_t time_start_4126 = 0, time_end_4127 = 0;
            
            if (ctx->debugging) {
                fprintf(ctx->log, "Launching %s with global work size [",
                        "main.scan_stage1_4064");
                fprintf(ctx->log, "%zu", global_work_sizze_4125[0]);
                fprintf(ctx->log, "] and local work size [");
                fprintf(ctx->log, "%zu", local_work_sizze_4129[0]);
                fprintf(ctx->log,
                        "]; local memory parameters sum to %d bytes.\n",
                        (int) (0 + smax64((int64_t) 1,
                                          (int64_t) sizeof(int32_t) *
                                          segscan_group_sizze_4059)));
                time_start_4126 = get_wall_time();
            }
            OPENCL_SUCCEED_OR_RETURN(clEnqueueNDRangeKernel(ctx->opencl.queue,
                                                            ctx->mainziscan_stage1_4064,
                                                            1, NULL,
                                                            global_work_sizze_4125,
                                                            local_work_sizze_4129,
                                                            0, NULL,
                                                            ctx->profiling_paused ||
                                                            !ctx->profiling ? NULL : opencl_get_event(&ctx->opencl,
                                                                                                      &ctx->mainziscan_stage1_4064_runs,
                                                                                                      &ctx->mainziscan_stage1_4064_total_runtime)));
            if (ctx->debugging) {
                OPENCL_SUCCEED_FATAL(clFinish(ctx->opencl.queue));
                time_end_4127 = get_wall_time();
                
                long time_diff_4128 = time_end_4127 - time_start_4126;
                
                fprintf(ctx->log, "kernel %s runtime: %ldus\n",
                        "main.scan_stage1_4064", time_diff_4128);
            }
        }
        if (ctx->debugging)
            fprintf(ctx->log, "%s: %llu%c", "elems_per_group",
                    (long long) (segscan_group_sizze_4059 *
                                 sdiv_up64(implz2080U_4048,
                                           sext_i32_i64(num_threads_4076))),
                    '\n');
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage2_4064, 1,
                                                smax64((int64_t) 1,
                                                       (int64_t) sizeof(int32_t) *
                                                       stage1_num_groups_4075),
                                                NULL));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage2_4064, 2,
                                                sizeof(implz2080U_4048),
                                                &implz2080U_4048));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage2_4064, 3,
                                                sizeof(stage1_num_groups_4075),
                                                &stage1_num_groups_4075));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage2_4064, 4,
                                                sizeof(num_threads_4076),
                                                &num_threads_4076));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage2_4064, 5,
                                                sizeof(mem_4070.mem),
                                                &mem_4070.mem));
        if (1 * ((size_t) (int64_t) 1 * (size_t) stage1_num_groups_4075) != 0) {
            const size_t global_work_sizze_4130[1] = {(size_t) (int64_t) 1 *
                         (size_t) stage1_num_groups_4075};
            const size_t local_work_sizze_4134[1] = {stage1_num_groups_4075};
            int64_t time_start_4131 = 0, time_end_4132 = 0;
            
            if (ctx->debugging) {
                fprintf(ctx->log, "Launching %s with global work size [",
                        "main.scan_stage2_4064");
                fprintf(ctx->log, "%zu", global_work_sizze_4130[0]);
                fprintf(ctx->log, "] and local work size [");
                fprintf(ctx->log, "%zu", local_work_sizze_4134[0]);
                fprintf(ctx->log,
                        "]; local memory parameters sum to %d bytes.\n",
                        (int) (0 + smax64((int64_t) 1,
                                          (int64_t) sizeof(int32_t) *
                                          stage1_num_groups_4075)));
                time_start_4131 = get_wall_time();
            }
            OPENCL_SUCCEED_OR_RETURN(clEnqueueNDRangeKernel(ctx->opencl.queue,
                                                            ctx->mainziscan_stage2_4064,
                                                            1, NULL,
                                                            global_work_sizze_4130,
                                                            local_work_sizze_4134,
                                                            0, NULL,
                                                            ctx->profiling_paused ||
                                                            !ctx->profiling ? NULL : opencl_get_event(&ctx->opencl,
                                                                                                      &ctx->mainziscan_stage2_4064_runs,
                                                                                                      &ctx->mainziscan_stage2_4064_total_runtime)));
            if (ctx->debugging) {
                OPENCL_SUCCEED_FATAL(clFinish(ctx->opencl.queue));
                time_end_4132 = get_wall_time();
                
                long time_diff_4133 = time_end_4132 - time_start_4131;
                
                fprintf(ctx->log, "kernel %s runtime: %ldus\n",
                        "main.scan_stage2_4064", time_diff_4133);
            }
        }
        
        int32_t required_groups_4112;
        
        required_groups_4112 = sext_i64_i32(sdiv_up64(implz2080U_4048,
                                                      segscan_group_sizze_4059));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage3_4064, 1,
                                                sizeof(implz2080U_4048),
                                                &implz2080U_4048));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage3_4064, 2,
                                                sizeof(num_groups_4061),
                                                &num_groups_4061));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage3_4064, 3,
                                                sizeof(num_threads_4076),
                                                &num_threads_4076));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage3_4064, 4,
                                                sizeof(required_groups_4112),
                                                &required_groups_4112));
        OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->mainziscan_stage3_4064, 5,
                                                sizeof(mem_4070.mem),
                                                &mem_4070.mem));
        if (1 * ((size_t) num_groups_4061 *
                 (size_t) segscan_group_sizze_4059) != 0) {
            const size_t global_work_sizze_4135[1] = {(size_t) num_groups_4061 *
                         (size_t) segscan_group_sizze_4059};
            const size_t local_work_sizze_4139[1] = {segscan_group_sizze_4059};
            int64_t time_start_4136 = 0, time_end_4137 = 0;
            
            if (ctx->debugging) {
                fprintf(ctx->log, "Launching %s with global work size [",
                        "main.scan_stage3_4064");
                fprintf(ctx->log, "%zu", global_work_sizze_4135[0]);
                fprintf(ctx->log, "] and local work size [");
                fprintf(ctx->log, "%zu", local_work_sizze_4139[0]);
                fprintf(ctx->log,
                        "]; local memory parameters sum to %d bytes.\n",
                        (int) 0);
                time_start_4136 = get_wall_time();
            }
            OPENCL_SUCCEED_OR_RETURN(clEnqueueNDRangeKernel(ctx->opencl.queue,
                                                            ctx->mainziscan_stage3_4064,
                                                            1, NULL,
                                                            global_work_sizze_4135,
                                                            local_work_sizze_4139,
                                                            0, NULL,
                                                            ctx->profiling_paused ||
                                                            !ctx->profiling ? NULL : opencl_get_event(&ctx->opencl,
                                                                                                      &ctx->mainziscan_stage3_4064_runs,
                                                                                                      &ctx->mainziscan_stage3_4064_total_runtime)));
            if (ctx->debugging) {
                OPENCL_SUCCEED_FATAL(clFinish(ctx->opencl.queue));
                time_end_4137 = get_wall_time();
                
                long time_diff_4138 = time_end_4137 - time_start_4136;
                
                fprintf(ctx->log, "kernel %s runtime: %ldus\n",
                        "main.scan_stage3_4064", time_diff_4138);
            }
        }
    }
    if (memblock_set_device(ctx, &out_mem_4072, &mem_4070, "mem_4070") != 0)
        return 1;
    (*out_mem_p_4124).references = NULL;
    if (memblock_set_device(ctx, &*out_mem_p_4124, &out_mem_4072,
                            "out_mem_4072") != 0)
        return 1;
    if (memblock_unref_device(ctx, &mem_4070, "mem_4070") != 0)
        return 1;
    if (memblock_unref_device(ctx, &out_mem_4072, "out_mem_4072") != 0)
        return 1;
                       ...
                       struct futhark_bool_1d *in1)
{
    ...
    xs_mem_4066.references = NULL;
    
    struct memblock_device ys_mem_4067;
    
    ys_mem_4067.references = NULL;
    
    int64_t implz2080U_4048;
    int64_t implz2081U_4049;
    struct memblock_device out_mem_4072;
    ...
    lock_lock(&ctx->lock);
    xs_mem_4066 = in0->mem;
    implz2080U_4048 = in0->shape[0];
    ys_mem_4067 = in1->mem;
    implz2081U_4049 = in1->shape[0];
    if (!(implz2080U_4048 == in0->shape[0] && implz2081U_4049 ==
          in1->shape[0])) {
        ret = 1;
        if (!ctx->error)
            ctx->error =
        ...
        ret = futrts_main(ctx, &out_mem_4072, xs_mem_4066, ys_mem_4067,
                          implz2080U_4048, implz2081U_4049);
        if (ret == 0) {
            assert((*out0 =
                    (struct futhark_i32_1d *) malloc(sizeof(struct futhark_i32_1d))) !=
                NULL);
            (*out0)->mem = out_mem_4072;
            (*out0)->shape[0] = implz2080U_4048;
        }
    }
    lock_unlock(&ctx->lock);
    return ret;
