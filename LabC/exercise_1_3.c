...
int futhark_entry_main(struct futhark_context *ctx, int32_t *out0,
                       int64_t *out1, const struct futhark_i32_1d *in0, const
...
struct type *main_out_types[] = {&type_i32, &type_i64, NULL};
struct type *main_in_types[] = {&type_i32_1d, &type_i32_1d, NULL};
...
struct type *types[] = {&type_i32, &type_i32_1d, &type_i64, NULL};
...
static int futrts_main(struct futhark_context *ctx,
                       int32_t *out_scalar_out_4529,
                       int64_t *out_scalar_out_4530,
                       struct memblock xs_mem_4523, struct memblock ys_mem_4524,
                       int64_t implz2081U_4494);
                       ...
                       int64_t implz2081U_4494)
{
    ...
    int err = 0;
    int32_t scalar_out_4525;
    int64_t scalar_out_4526;
    int32_t defunc_2_reduce_comm_res_4498;
    int64_t defunc_2_reduce_comm_res_4499;
    int32_t redout_4518;
    int64_t redout_4519;
    
    redout_4518 = 0;
    redout_4519 = (int64_t) -1;
    for (int64_t i_4520 = 0; i_4520 < implz2081U_4494; i_4520++) {
        int32_t x_4513 = ((int32_t *) xs_mem_4523.mem)[i_4520];
        int32_t x_4514 = ((int32_t *) ys_mem_4524.mem)[i_4520];
        int32_t defunc_1_f_res_4516 = sub32(x_4513, x_4514);
        int32_t defunc_0_f_res_4517 = abs(defunc_1_f_res_4516);
        bool cond_4504 = slt32(defunc_0_f_res_4517, redout_4518);
        int32_t defunc_1_op_res_4505;
        int64_t defunc_1_op_res_4506;
        
        if (cond_4504) {
            defunc_1_op_res_4505 = redout_4518;
            defunc_1_op_res_4506 = redout_4519;
        } else {
            bool cond_4507 = slt32(redout_4518, defunc_0_f_res_4517);
            int32_t defunc_1_op_res_f_res_4508;
            int64_t defunc_1_op_res_f_res_4509;
            
            if (cond_4507) {
                defunc_1_op_res_f_res_4508 = defunc_0_f_res_4517;
                defunc_1_op_res_f_res_4509 = i_4520;
            } else {
                bool cond_4510 = slt64(i_4520, redout_4519);
                int32_t defunc_1_op_res_f_res_f_res_4511;
                
                if (cond_4510) {
                    defunc_1_op_res_f_res_f_res_4511 = redout_4518;
                } else {
                    defunc_1_op_res_f_res_f_res_4511 = defunc_0_f_res_4517;
                }
                
                int64_t defunc_1_op_res_f_res_f_res_4512;
                
                if (cond_4510) {
                    defunc_1_op_res_f_res_f_res_4512 = redout_4519;
                } else {
                    defunc_1_op_res_f_res_f_res_4512 = i_4520;
                }
                defunc_1_op_res_f_res_4508 = defunc_1_op_res_f_res_f_res_4511;
                defunc_1_op_res_f_res_4509 = defunc_1_op_res_f_res_f_res_4512;
            }
            defunc_1_op_res_4505 = defunc_1_op_res_f_res_4508;
            defunc_1_op_res_4506 = defunc_1_op_res_f_res_4509;
        }
        
        int32_t redout_tmp_4527 = defunc_1_op_res_4505;
        int64_t redout_tmp_4528 = defunc_1_op_res_4506;
        
        redout_4518 = redout_tmp_4527;
        redout_4519 = redout_tmp_4528;
    }
    defunc_2_reduce_comm_res_4498 = redout_4518;
    defunc_2_reduce_comm_res_4499 = redout_4519;
    scalar_out_4525 = defunc_2_reduce_comm_res_4498;
    scalar_out_4526 = defunc_2_reduce_comm_res_4499;
    *out_scalar_out_4529 = scalar_out_4525;
    *out_scalar_out_4530 = scalar_out_4526;
...
int futhark_entry_main(struct futhark_context *ctx, int32_t *out0,
                       ...
                       struct futhark_i32_1d *in1)
{
    struct memblock xs_mem_4523;
    
    xs_mem_4523.references = NULL;
    
    struct memblock ys_mem_4524;
    
    ys_mem_4524.references = NULL;
    ...
    lock_lock(&ctx->lock);
    xs_mem_4523 = in0->mem;
    implz2081U_4494 = in0->shape[0];
    ys_mem_4524 = in1->mem;
    implz2081U_4494 = in1->shape[0];
    if (!(implz2081U_4494 == in0->shape[0] && implz2081U_4494 ==
          in1->shape[0])) {
        ret = 1;
        if (!ctx->error)
            ctx->error =
        ...
        ret = futrts_main(ctx, &scalar_out_4525, &scalar_out_4526, xs_mem_4523,
                          ys_mem_4524, implz2081U_4494);
        if (ret == 0) {
            *out0 = scalar_out_4525;
            *out1 = scalar_out_4526;
        }
    }
    lock_unlock(&ctx->lock);
    return ret;
